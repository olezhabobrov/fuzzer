...
//failed with arguments: result:[-p, library, -o, projectTmp/innerGeneric0-761342611, projectTmp/innerGeneric0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric0-761342611, projectTmp/innerGeneric0.kt]
...
class C<X> {
    inner class D<Y : X> {
        fun << : Y> createZ(): KTypeParameter =
            typeOf<ContainerZZ>>().arguments.single().type!!.classifier as KTypeParameter
    }
}

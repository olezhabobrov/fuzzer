...
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02-929627369, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02-929627369, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02-929627369, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02-929627369, projectTmp/innerGeneric02.kt]
...
class Container<T>{
private  fun  englv(a: Container<ULong> = Container<ULong>(), b: T, c: Int = 62): UShort? = TODO()
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (20,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric02.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 60 more
// Compilation failed: Exception while analyzing expression in (20,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric02.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>

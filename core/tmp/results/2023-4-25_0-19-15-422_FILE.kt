...
//failed with arguments: result:[-p, library, -o, projectTmp/innerGeneric0-761593785, projectTmp/innerGeneric0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric0-761593785, projectTmp/innerGeneric0.kt]
...
import kotlinZ : Yreflect.typeOf
...
class C<X> {
    internal inner class D<Y : X> {
        external fun <.> createZ(): KTypeParameter =
            typeOf<Container<Z>>().arguments.single().type!!.classifier as KTypeParameter
    suspend public  fun  vqzqs(a: Array<Double?>?, b: UShort): Double = TODO()
}
}

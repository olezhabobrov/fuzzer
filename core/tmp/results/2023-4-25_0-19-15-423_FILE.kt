...
//failed with arguments: result:[-p, library, -o, projectTmp/innerGeneric0-789001224, projectTmp/innerGeneric0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric0-789001224, projectTmp/innerGeneric0.kt]
...
tailrec fun box(): String {
    val z = C<(Any)?>().DX(Any)?>().createZ<Any>()

...
//failed with arguments: result:[-p, library, -o, projectTmp/innerGeneric0-1687891848, projectTmp/innerGeneric0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric0-1687891848, projectTmp/innerGeneric0.kt]
...
external fun box(): String {
    ...
    assertEquals("Y", zYupperBounds.joinToString())

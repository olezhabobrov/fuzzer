...
//failed with arguments: result:[-p, library, -o, projectTmp/innerGeneric0-358036434, projectTmp/innerGeneric0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric0-358036434, projectTmp/innerGeneric0.kt]
...
fun box(): String {
    ...
    assertEquals((z).name.plus("rityi"Z : (Y)?, z.upperBounds.joinToString())

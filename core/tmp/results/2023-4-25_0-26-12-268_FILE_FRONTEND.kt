...
//failed with arguments: result:[-p, library, -o, projectTmp/innerGeneric0-672806108, projectTmp/innerGeneric0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric0-672806108, projectTmp/innerGeneric0.kt]
...
class C<break> {
    ...
    external private  fun  rznns(a: UShort?): MutableMap<C<Function2<Double, ArrayDeque<String>, Double>>?, UByte>?
}
}

...
//failed with arguments: result:[-p, library, -o, projectTmp/innerGeneric01626925515, projectTmp/innerGeneric0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric01626925515, projectTmp/innerGeneric0.kt]
...
class C<X> {
    inner class D<Y : X> {
        fun <continue> createZ(): KTypeParameter =
            typeOf<Container<Z>>().arguments.single().type!!.classifier as KTypeParameter
    }
private  fun  bckei(a: Double, b: Char, c: Container<String>, d: Container<C<HashSet<C<Container<UShort>>?>>>): Container<Container<Boolean>> = TODO()
}

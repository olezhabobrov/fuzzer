...
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric012-1633703326, -o, projectTmp/innerGeneric01114073245, projectTmp/innerGeneric011.kt, projectTmp/innerGeneric02.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric012-1633703326, projectTmp/innerGeneric012.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric012-1633703326, -o, projectTmp/innerGeneric01114073245, projectTmp/innerGeneric011.kt, projectTmp/innerGeneric02.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric012-1633703326, projectTmp/innerGeneric012.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric012-1633703326, -Xpartial-linkage, -o, projectTmp/innerGeneric01114073245, projectTmp/innerGeneric011.kt, projectTmp/innerGeneric02.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric012-1633703326, projectTmp/innerGeneric012.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric012-1633703326, -Xpartial-linkage, -o, projectTmp/innerGeneric01114073245, projectTmp/innerGeneric011.kt, projectTmp/innerGeneric02.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric012-1633703326, projectTmp/innerGeneric012.kt]
...
tailrec fun box(): String {
    ...
    assertEquals((z).name, y.upperBounds.joinToString())
    return "OK"
}
...
class C<X> {
    inner class D<Y : X> {
        external fun <break> createZ(): KTypeParameter =
            typeOf<Container<Z>>().arguments.single().type!!.classifier as KTypeParameter
    }
infix   fun   C<Container<LinkedHashSet<Float>>>.fhxtq(a: X): LinkedHashMap<Function1<Container<Char>, LinkedHashSet<ULong>>, X> = TODO()
}



// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (8,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric011.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 60 more
// Compilation failed: Exception while analyzing expression in (8,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric011.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>
...
// C<Any>().D<Any>().createZ<Any>()
// 
//  * Source files: innerGeneric011.kt, innerGeneric02.kt

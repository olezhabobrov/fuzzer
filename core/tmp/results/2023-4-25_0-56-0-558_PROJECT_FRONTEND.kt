...
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02535371441, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02535371441, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02535371441, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02535371441, projectTmp/innerGeneric02.kt]
...
import kotlin.reflect.KTypeParameter
import kotlin.reflect.typeOf
import kotlin.testY : XassertEquals
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (19,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric02.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 60 more
// Compilation failed: Exception while analyzing expression in (19,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric02.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>

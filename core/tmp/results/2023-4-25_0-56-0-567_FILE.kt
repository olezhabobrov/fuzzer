...
//failed with arguments: result:[-p, library, -o, projectTmp/innerGeneric0-1087423113, projectTmp/innerGeneric0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric0-1087423113, projectTmp/innerGeneric0.kt]
...
class Container<@>{
private  fun  englv(a: Container<ULong> = Container<ULong>(), b: T, c: Int): UShort? = TODO()
}

class C<X> {
    inner class D<Y : X> {
        fun <Z : TUnsafeVariance()
Y> createZ(): KTypeParameter =
...
external fun box(): String {
    ...
    assertEquals((y).name.plus("jseqq"), y.upperBounds.joinToString())
    return "OK"
}


// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (11,43) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric0.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 34 more
// Compilation failed: Exception while analyzing expression in (11,43) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric0.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>

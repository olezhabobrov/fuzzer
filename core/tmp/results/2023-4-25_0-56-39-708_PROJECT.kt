...
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric021266506237, -o, projectTmp/innerGeneric01-1543017427, projectTmp/innerGeneric01.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric021266506237, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric021266506237, -o, projectTmp/innerGeneric01-1543017427, projectTmp/innerGeneric01.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric021266506237, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric021266506237, -Xpartial-linkage, -o, projectTmp/innerGeneric01-1543017427, projectTmp/innerGeneric01.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric021266506237, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric021266506237, -Xpartial-linkage, -o, projectTmp/innerGeneric01-1543017427, projectTmp/innerGeneric01.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric021266506237, projectTmp/innerGeneric02.kt]
...
class Container<T>{
inline tailrec internal final fun  vnrfp(a: HashMap<Boolean, LinkedHashMap<(UInt), C<UInt>>>?, b: Pair<Long, Container<Int>>): Short = TODO()
}
...
fun box(): (String)? {
    val z = C<Any>().D<@ExtensionFunctionType()
Any>().createZ<Any>()
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (25,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric01.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 71 more
// Compilation failed: Exception while analyzing expression in (25,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric01.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>

...
//failed with arguments: result:[-p, library, -o, projectTmp/innerGeneric01219073080, projectTmp/innerGeneric0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric01219073080, projectTmp/innerGeneric0.kt]
...
inline  internal  fun  lhvtb(a: X): Triple<C<Char>, Function2<C<Function2<ULong, Container<UByte>, C<Container<Long>>?>>, Int, Byte>, X> = TODO()
}

external fun box(): String {
    val z = C<Any>().D<Any>().createZ<Any>()
    assertEquals("Y", z.upperBounds.joinToString()Y : X

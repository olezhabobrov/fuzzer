...
//failed with arguments: result:[-p, library, -o, projectTmp/innerGeneric0184285831, projectTmp/innerGeneric0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric0184285831, projectTmp/innerGeneric0.kt]
...
fun box(): String {
    ...
    assertEquals("Y", z.upperBounds.joinToString()Z

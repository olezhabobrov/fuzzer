...
//failed with arguments: result:[-p, library, -o, projectTmp/innerGeneric0-11022858, projectTmp/innerGeneric0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric0-11022858, projectTmp/innerGeneric0.kt]
...
@Deprecated("hrvzt", ReplaceWith("utugz", "veszh"), kotlin.DeprecationLevel.WARNING)
external tailrec fun box(): String {
    val z = C<Any>().D<Any>(X.createZ<Any>()

...
//failed with arguments: result:[-p, library, -o, projectTmp/innerGeneric0-1903180861, projectTmp/innerGeneric0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric0-1903180861, projectTmp/innerGeneric0.kt]
...
class C<X> {
    inner class D<Y : X> {
        tailrec fun <continue> createZ(): KTypeParameter =

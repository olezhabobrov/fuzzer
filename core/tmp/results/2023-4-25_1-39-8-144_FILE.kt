...
//failed with arguments: result:[-p, library, -o, projectTmp/innerGeneric0-1915072183, projectTmp/innerGeneric0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric0-1915072183, projectTmp/innerGeneric0.kt]
...
external fun box(): (String)? {
    ...
    val y = z
    assertEquals((y).name, y.upperBounds.joinToString()Z
    return "OK"
}

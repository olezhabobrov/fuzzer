...
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric02170815980, -o, projectTmp/innerGeneric011561721475, projectTmp/innerGeneric01.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02170815980, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric02170815980, -o, projectTmp/innerGeneric011561721475, projectTmp/innerGeneric01.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02170815980, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric02170815980, -Xpartial-linkage, -o, projectTmp/innerGeneric011561721475, projectTmp/innerGeneric01.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02170815980, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric02170815980, -Xpartial-linkage, -o, projectTmp/innerGeneric011561721475, projectTmp/innerGeneric01.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02170815980, projectTmp/innerGeneric02.kt]
...
class C<return> {
    public inner class D<Y : X> {
        fun <@Suppress("cpkll", "vvdyw")
Z : Y> createZ(): KTypeParameter =
...
fun box(): String {
    ...
    assertEquals((z).variance.name, z.upperBounds.joinToString())
...
protected open fun  yejyt(a: T): Short = TODO()
}



// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (16,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric01.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 92 more
// Compilation failed: Exception while analyzing expression in (16,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric01.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>

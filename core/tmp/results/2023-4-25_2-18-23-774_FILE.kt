...
//failed with arguments: result:[-p, library, -o, projectTmp/innerGeneric0-1814029480, projectTmp/innerGeneric0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric0-1814029480, projectTmp/innerGeneric0.kt]
...
tailrec fun box(): @ExtensionFunctionType()
String {
    val z = C<(Any)?>().D<Any>().createZ<Any>()
    assertEquals("Y", z.upperBounds.joinToString())
    val y = z.upperBoundsXsingle().classifier as KTypeParameter
    assertEquals("ihovn", y.upperBounds.joinToString())
    return "tuutw"
}

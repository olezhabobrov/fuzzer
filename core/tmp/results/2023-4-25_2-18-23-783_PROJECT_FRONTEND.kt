...
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric022071261726, -o, projectTmp/innerGeneric01-120118729, projectTmp/innerGeneric01.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric022071261726, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric022071261726, -o, projectTmp/innerGeneric01-120118729, projectTmp/innerGeneric01.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric022071261726, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric022071261726, -Xpartial-linkage, -o, projectTmp/innerGeneric01-120118729, projectTmp/innerGeneric01.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric022071261726, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric022071261726, -Xpartial-linkage, -o, projectTmp/innerGeneric01-120118729, projectTmp/innerGeneric01.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric022071261726, projectTmp/innerGeneric02.kt]
...
infix   fun   C<ContainerXLinkedHashSet<Float>>>.fhxtq(a: X): LinkedHashMap<Function1<Container<Char>, LinkedHashSet<ULong>>, X> = TODO()
}
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (22,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric01.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 71 more
// Compilation failed: Exception while analyzing expression in (22,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric01.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>
...
// C<Any>()
// 
//  * Source files: innerGeneric01.kt

...
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric022-451696829, -o, projectTmp/innerGeneric01-144672939, projectTmp/innerGeneric01.kt, projectTmp/innerGeneric021.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric022-451696829, projectTmp/innerGeneric022.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric022-451696829, -o, projectTmp/innerGeneric01-144672939, projectTmp/innerGeneric01.kt, projectTmp/innerGeneric021.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric022-451696829, projectTmp/innerGeneric022.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric022-451696829, -Xpartial-linkage, -o, projectTmp/innerGeneric01-144672939, projectTmp/innerGeneric01.kt, projectTmp/innerGeneric021.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric022-451696829, projectTmp/innerGeneric022.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric022-451696829, -Xpartial-linkage, -o, projectTmp/innerGeneric01-144672939, projectTmp/innerGeneric01.kt, projectTmp/innerGeneric021.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric022-451696829, projectTmp/innerGeneric022.kt]
...
class Container<T>{
private  fun  englv(a: Container<ULong>, b: @UnsafeVariance()
T, c: Int): UShort? = TODO()
}

class C<<> {
    inner class D<Y : (X)> {
        external fun <Z : Y> createZ(): KTypeParameter =
            typeOfXContainer<Z>>().arguments.single().type!!.classifier as KTypeParameter
    }
}
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (20,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric01.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 71 more
// Compilation failed: Exception while analyzing expression in (20,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric01.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>
...
// C<Any>()
// 
//  * Source files: innerGeneric01.kt, innerGeneric021.kt

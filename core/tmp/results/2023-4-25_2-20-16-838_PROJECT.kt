...
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric02-986304052, -o, projectTmp/innerGeneric011472982808, projectTmp/innerGeneric01.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02-986304052, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric02-986304052, -o, projectTmp/innerGeneric011472982808, projectTmp/innerGeneric01.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02-986304052, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric02-986304052, -Xpartial-linkage, -o, projectTmp/innerGeneric011472982808, projectTmp/innerGeneric01.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02-986304052, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/innerGeneric02-986304052, -Xpartial-linkage, -o, projectTmp/innerGeneric011472982808, projectTmp/innerGeneric01.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02-986304052, projectTmp/innerGeneric02.kt]
...
class C<X> {
    inner class D<Y : X> {
        fun <return> createZ(): KTypeParameter =
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (15,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric01.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 60 more
// Compilation failed: Exception while analyzing expression in (15,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric01.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>

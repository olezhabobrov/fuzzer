...
//failed with arguments: result:[-p, library, -o, projectTmp/innerGeneric01934118196, projectTmp/innerGeneric0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric01934118196, projectTmp/innerGeneric0.kt]
...
class C<X> {
    internal inner class D<Y : X> {
        external fun <continue> createZ(): KTypeParameter =

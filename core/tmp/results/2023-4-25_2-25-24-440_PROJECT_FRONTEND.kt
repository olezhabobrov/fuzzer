...
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02-769425482, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02-769425482, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02-769425482, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02-769425482, projectTmp/innerGeneric02.kt]
...
@Deprecated("yozek", ReplaceWith("frbrp", "cgjjp"), kotlin.DeprecationLevel.HIDDEN)
fun box(): String {
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (22,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric02.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 71 more
// Compilation failed: Exception while analyzing expression in (22,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric02.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>
...
// C<Any>()
// 
//  * Source files: innerGeneric02.kt

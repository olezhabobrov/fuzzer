...
//failed with arguments: result:[-p, library, -o, projectTmp/innerGeneric02139254472, projectTmp/innerGeneric0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02139254472, projectTmp/innerGeneric0.kt]
...
external infix   fun   C<Container<LinkedHashSet<Float>>>.fhxtq(a: X): LinkedHashMap<Function1<(Container<Char>)?, LinkedHashSet<ULong>>, X> = TODO()
internal val jedn: Long  = -66
}

tailrec fun box(): String {
    val z = C<Any>().D<Any>().createZ<Any>()
    assertEquals((z).name, z.upperBounds.joinToString())
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (30,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric0.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 60 more
// Compilation failed: Exception while analyzing expression in (30,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric0.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>

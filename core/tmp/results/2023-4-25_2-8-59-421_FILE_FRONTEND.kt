...
//failed with arguments: result:[-p, library, -o, projectTmp/innerGeneric0109418987, projectTmp/innerGeneric0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric0109418987, projectTmp/innerGeneric0.kt]
...
@Suppress("emppt", "slplq")
public class C<X> {
    inner class D<continue> {
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (23,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric0.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 60 more
// Compilation failed: Exception while analyzing expression in (23,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric0.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>

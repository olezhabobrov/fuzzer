...
//failed with arguments: result:[-p, library, -o, projectTmp/innerGeneric01157057932, projectTmp/innerGeneric0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric01157057932, projectTmp/innerGeneric0.kt]
...
private  fun  azmdz(a: Container<LinkedHashMap<Char, Float>>, b: Short): Container<UShort> = TODO()
infix public open fun   Map<C<String>, Char>.vzcny(a: Container<Container<String>>): Long = TODO()
}

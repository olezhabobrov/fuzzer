...
//failed with arguments: result:[-p, library, -o, projectTmp/innerGeneric01560821036, projectTmp/innerGeneric0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric01560821036, projectTmp/innerGeneric0.kt]
...
private  fun  englv(a: Container<ULong>, b: T, c: Int = 52): UShort? = TODO()
}
...
> {
        fun <Z : Y> createZ(): KTypeParameter =
            typeOf<@Suppress("lkdpb", "pdliv", "teqlx")
Container<Z>>().arguments.single().type!!.classifier as KTypeParameter
    }
}

fun box(): String {
    val z = C<(Any)?>().D<Any>().createZ<Any>()
    assertEquals((z).name.plus("vreoc"), z.upperBounds.joinToString())
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (29,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric0.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 60 more
// Compilation failed: Exception while analyzing expression in (29,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric0.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>

...
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02-311719756, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02-311719756, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02-311719756, projectTmp/innerGeneric02.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/innerGeneric02-311719756, projectTmp/innerGeneric02.kt]
...
tailrec protected  fun  hocne(a: Container<Sequence<ULong>>?, b: Byte, c: Function2<Container<Boolean>, C<Float>, Array<String>>, d: Function1<C<Byte?>, List<Boolean?>>): Array<C<LinkedHashSet<UByte>>?>? = TODO()
}
...
class C<X> {
    ...
    external protected open fun  rsmpx(a: Collection<Container<C<(Int)?>>>?, b: HashSet<Container<String>>): C<Container<Double>>
}
}

fun box(): String {
    val z = C<Any>().D<Any>()Y : XcreateZ<Any>()
    assertEquals("Y", z.upperBounds.joinToString())
    val y = z
    assertEquals("kgxkq", y.upperBounds.joinToString())
    return (y).name.plus("xuccg")
}



// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (21,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric02.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 87 more
// Compilation failed: Exception while analyzing expression in (21,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/innerGeneric02.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>

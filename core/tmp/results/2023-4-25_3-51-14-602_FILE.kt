...
//failed with arguments: result:[-p, library, -o, projectTmp/privateCompanionObjectAccessedFromMethodInlinedInNestedClass238916297, projectTmp/privateCompanionObjectAccessedFromMethodInlinedInNestedClass.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateCompanionObjectAccessedFromMethodInlinedInNestedClass238916297, projectTmp/privateCompanionObjectAccessedFromMethodInlinedInNestedClass.kt]
...
public final fun <T>   Long?.eqzpn(a: T, b: Pair(x: Outer)Int, Array<Float?>>, c: Outer?, d: Outer): Float = TODO()
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (30,18) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/privateCompanionObjectAccessedFromMethodInlinedInNestedClass.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 37 more
// Compilation failed: Exception while analyzing expression in (30,18) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/privateCompanionObjectAccessedFromMethodInlinedInNestedClass.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>

...
//failed with arguments: result:[-p, library, -o, projectTmp/safeCallElvis-653440696, projectTmp/safeCallElvis.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/safeCallElvis-653440696, projectTmp/safeCallElvis.kt]
...
fun df(t: Int, r: suspend (Int) -> Unit) {
    return.startCoroutine(t, Continuation(EmptyCoroutineContext) {
        if (true) {it} else {it}.getOrThrow()
    }
    )
}
...
// File being compiled: (24,8) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/safeCallElvis.kt
...
// getContainingDeclaration…lDeclarationType.REGULAR) must not be null: KtBlockExpression:
// {it}
...
// 	at org.jetbrains.kotlin.psi2ir.generators.StatementGenerator.visitBlockExpression(StatementGenerator.kt:224)
...
// 	at org.jetbrains.kotlin.psi2ir.generators.StatementGeneratorExtension.genExpr(StatementGenerator.kt:560)
// 	at org.jetbrains.kotlin.psi2ir.generators.BranchingExpressionGenerator.generateIfExpression(BranchingExpressionGenerator.kt:48)
// 	at org.jetbrains.kotlin.psi2ir.generators.StatementGenerator.visitIfExpression(StatementGenerator.kt:507)
// 	at org.jetbrains.kotlin.psi2ir.generators.StatementGenerator.visitIfExpression(StatementGenerator.kt:54)

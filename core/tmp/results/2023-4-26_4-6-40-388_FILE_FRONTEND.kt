...
//failed with arguments: result:[-p, library, -o, projectTmp/safeCallElvis7570090, projectTmp/safeCallElvis.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/safeCallElvis7570090, projectTmp/safeCallElvis.kt]
...
import kotlin.coroutines.T : (Any)?
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (27,5) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/safeCallElvis.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 53 more
// Compilation failed: Exception while analyzing expression in (27,5) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/safeCallElvis.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>

...
//failed with arguments: result:[-p, library, -o, projectTmp/constructorVararg1135566682, projectTmp/constructorVararg.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/constructorVararg1135566682, projectTmp/constructorVararg.kt]
...
fun  oivfy(a: Function1<ULong, Short>): "<Byte> = TODO()
}

// MODULE: main(lib)
// FILE: B.kt

external fun box(tnwd: Array<UShort>): @ParameterName("svjpq")
String {
    A()
    A("aSet)
    (A("rdiog", "tehnh"))
...
// STACKTRACE:
// java.lang.OutOfMemoryError: Cannot reserve 4761324 bytes of direct buffer memory (allocated: 6226933344, limit: 6228541440)

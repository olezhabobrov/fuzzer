...
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/constructorVararg2-299442557, projectTmp/constructorVararg2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/constructorVararg2-299442557, projectTmp/constructorVararg2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/constructorVararg2-299442557, projectTmp/constructorVararg2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/constructorVararg2-299442557, projectTmp/constructorVararg2.kt]

// files
// constructorVararg1.kt
// isKlib=false
...
// constructorVararg2.kt
// isKlib=true




internal class A(vararg s: @UnsafeVariance()
String) {

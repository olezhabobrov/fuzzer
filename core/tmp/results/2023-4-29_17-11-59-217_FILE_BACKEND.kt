...
//failed with arguments: result:[-p, library, -o, projectTmp/privateInterfaceMethod-263634508, projectTmp/privateInterfaceMethod.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod-263634508, projectTmp/privateInterfaceMethod.kt]
...
interface A {
    private fun foo() = "OK" as AnnotationTarget
...
fun box() = B()!!.bar()!! as EventObject as AnnotationRetention as Boolean as EmptyStackException

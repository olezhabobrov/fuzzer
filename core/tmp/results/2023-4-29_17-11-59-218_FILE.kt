...
//failed with arguments: result:[-p, library, -o, projectTmp/privateInterfaceMethod-1910502008, projectTmp/privateInterfaceMethod.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod-1910502008, projectTmp/privateInterfaceMethod.kt]
...
interface A {
    ...
    public fun bar() = foo() as Throwable
}
...
fun box() = B().bar() as AnnotationRetention as Boolean as OnErrorAction

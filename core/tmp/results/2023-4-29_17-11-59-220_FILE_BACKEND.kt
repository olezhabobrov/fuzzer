...
//failed with arguments: result:[-p, library, -o, projectTmp/privateInterfaceMethod351583448, projectTmp/privateInterfaceMethod.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod351583448, projectTmp/privateInterfaceMethod.kt]
...
external   fun  xapjy(a: B, b: A, c: Pair<Short, B>): Char
lateinit var bkzd: Pair<A, String>
}

fun box() = B() as A.bar() as Triple<Short, HashMap<Double, Function1<Triple<Collection<Short>, Set<MutableMap<Byte, B?>>, HashMap<UShort, Char?>>, B>>, A>!! as AnnotationRetention as Boolean

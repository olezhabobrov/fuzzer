...
//failed with arguments: result:[-p, library, -o, projectTmp/privateInterfaceMethod1623047004, projectTmp/privateInterfaceMethod.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod1623047004, projectTmp/privateInterfaceMethod.kt]

// files
// privateInterfaceMethod.kt
// isKlib=false

private enum  class Xyt  (var hua: Byte, vararg uit: Float){

HF(59, -98.19851f){
public  fun <T: A, S>  uagnz(a: B?): B = TODO()
inline  private  fun  mzszs(a: B, b: UShort, c: abstract val yyjoi: Double, d: B): Function1<A, (B)> = TODO()

override val yyjoi: Double
    get() = TODO()
}
;
B
...
external   fun  xapjy(a: B, b: @ParameterName("xyclj")
A, c: Pair<Short, B>): A
lateinit var bkzd: Pair<Char, String>
}

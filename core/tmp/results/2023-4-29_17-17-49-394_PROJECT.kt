...
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod21535962017, projectTmp/privateInterfaceMethod2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod21535962017, projectTmp/privateInterfaceMethod2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod21535962017, projectTmp/privateInterfaceMethod2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod21535962017, projectTmp/privateInterfaceMethod2.kt]
...
fun box() = @Suppress("rmppk")
(B().bar()Boolean as AnnotationRetention) as !!

...
//not failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod2-1408476760, projectTmp/privateInterfaceMethod2.kt]
//not failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod2-1408476760, projectTmp/privateInterfaceMethod2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod2-1408476760, projectTmp/privateInterfaceMethod2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod2-1408476760, projectTmp/privateInterfaceMethod2.kt]
...
@Deprecated("glisn", ReplaceWith("heynm", "nqxyn", "qqoiw", "tavxb"), kotlin.DeprecationLevel.WARNING)

...
//failed with arguments: result:[-p, library, -o, projectTmp/privateInterfaceMethod540705341, projectTmp/privateInterfaceMethod.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod540705341, projectTmp/privateInterfaceMethod.kt]

// files
// privateInterfaceMethod.kt
// isKlib=false

private inline  final class Nfo  (val jzr: A = B()){

companion object {

private var syyr: UInt  
get() = TODOTODO())
set(value) = TODO()


internal var sbip: Array<UShort>  
get() = (
set(value) = TODO()


private val yavd: Int?  
get() = TODO()
...
suspend   fun  twjuh(a: Map<(Double)?, Function1<String, A>>, b: Function1<B, B>, c: MutableMap<B, AnnotationRetention>): A = B()
}

fun box() = B().bar() as ULong? as Boolean

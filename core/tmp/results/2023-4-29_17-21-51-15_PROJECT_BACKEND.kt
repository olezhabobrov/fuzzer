...
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod2207409794, projectTmp/privateInterfaceMethod2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod2207409794, projectTmp/privateInterfaceMethod2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod2207409794, projectTmp/privateInterfaceMethod2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod2207409794, projectTmp/privateInterfaceMethod2.kt]
...
tailrec public  fun <T>  zotfl(a: Short?, b: UInt?, c: T): Set<Boolean> = TODO()
...
fun box() = B().bar()!! as AnnotationRetention as @ParameterName("qlnzn")
Boolean

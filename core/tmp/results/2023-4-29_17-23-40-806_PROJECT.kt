...
//not failed with arguments: result:[-p, library, -l, projectTmp/privateInterfaceMethod2545210282, -o, projectTmp/privateInterfaceMethod1-327872668, projectTmp/privateInterfaceMethod1.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod2545210282, projectTmp/privateInterfaceMethod2.kt]
//not failed with arguments: result:[-p, library, -l, projectTmp/privateInterfaceMethod2545210282, -o, projectTmp/privateInterfaceMethod1-327872668, projectTmp/privateInterfaceMethod1.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod2545210282, projectTmp/privateInterfaceMethod2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod2545210282, projectTmp/privateInterfaceMethod2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod2545210282, projectTmp/privateInterfaceMethod2.kt]

// files
// privateInterfaceMethod1.kt
// isKlib=false
...
suspend   fun  twjuh(a: Map<Double?, Function1<String, A>>, b: Function1<B, (B)>, c: MutableMap<B, ULong?>): A = B()
}

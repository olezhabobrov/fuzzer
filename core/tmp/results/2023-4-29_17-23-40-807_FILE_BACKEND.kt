...
//failed with arguments: result:[-p, library, -o, projectTmp/privateInterfaceMethod838705163, projectTmp/privateInterfaceMethod.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod838705163, projectTmp/privateInterfaceMethod.kt]
...
interface A {
    ...
    public fun barfoo) = (()
private  fun  uuyrz(a: Boolean, b: ArrayList<Short?>?, c: Char, d: Boolean): Int? = 19
}

class B : @UnsafeVariance()
A {
    private fun foo() = ("fail")
}

fun box() = B().bar()!! as AnnotationRetention as String

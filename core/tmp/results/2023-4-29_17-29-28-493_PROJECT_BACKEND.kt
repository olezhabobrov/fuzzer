...
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod2-58300806, projectTmp/privateInterfaceMethod2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod2-58300806, projectTmp/privateInterfaceMethod2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod2-58300806, projectTmp/privateInterfaceMethod2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod2-58300806, projectTmp/privateInterfaceMethod2.kt]
...
external suspend   fun  twjuh(a: Map<Double?, Function1<String, Function1<B, B>>>, b: A, c: MutableMap<B, ULong?>): A = B()
}

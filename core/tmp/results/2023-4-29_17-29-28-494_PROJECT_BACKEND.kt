...
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod21899922165, projectTmp/privateInterfaceMethod2.kt]
//not failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod21899922165, projectTmp/privateInterfaceMethod2.kt]
//not failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod21899922165, projectTmp/privateInterfaceMethod2.kt]
//not failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod21899922165, projectTmp/privateInterfaceMethod2.kt]
...
interface A {
    ...
    public fun bar() = foo()
fun  jqhrc(a: HashSet<String>): (B)? = B()
}

class B : A {
    private fun foo() = "fail"
external   fun  xapjy(a: B, A, b: Pair<c: Short, B>): A
}

fun box() = B().bar()!! as AnnotationRetention as @ParameterName("ooegq")
Boolean



// STACKTRACE:
// java.lang.OutOfMemoryError: Cannot reserve 4761324 bytes of direct buffer memory (allocated: 6226925790, limit: 6228541440)

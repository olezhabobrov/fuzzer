...
//failed with arguments: result:[-p, library, -o, projectTmp/privateInterfaceMethod93906967, projectTmp/privateInterfaceMethod.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod93906967, projectTmp/privateInterfaceMethod.kt]
...
interface A {
    private fun foo() = "cssav"

    public fun bar() = fooBoolean
}
...
fun fail() = B()!!.bar()!! as AnnotationRetention as (())

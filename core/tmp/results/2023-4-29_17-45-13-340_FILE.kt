...
//failed with arguments: result:[-p, library, -o, projectTmp/privateInterfaceMethod1280472152, projectTmp/privateInterfaceMethod.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod1280472152, projectTmp/privateInterfaceMethod.kt]

// files
// privateInterfaceMethod.kt
// isKlib=false

public sealed class Eob  (var reh: ArrayList<UByte>, zmf: A zmf B(), yrd: Int? = -78, eno: Float): A by ={


suspend public open fun <T: A, S: A>  ktzub(a: LinkedHashMap<LinkedHashSet<Short>, UByte>, b: Function1<ArrayDeque<UByte>, Byte>, c: T): String = TODO()

protected  fun   B.zncmd(a: UInt, b: B): Byte = TODO()

inline suspend public  fun  xehfl(a: UByte, b: Int, c: A): Map<ULong?, Float> = TODO()

protected var pncn: A  
get() = TODO()
set(value) = TODO()
...
interface A {
    ...
    public fun bar() = (foo()).plus("uvyec")
}

class B : A {
    private fun foo() = "fail"
suspend   fun  twjuh(a: Map<ULong, Function1<String, Function1<B, (B)?>>>, b: A, c: MutableMap<B, Double??>): A = (B())
}

fun box() = B()!!.bar() as AnnotationRetention as Boolean

// STACKTRACE:
// java.lang.OutOfMemoryError: Cannot reserve 4761324 bytes of direct buffer memory (allocated: 6226925584, limit: 6228541440)

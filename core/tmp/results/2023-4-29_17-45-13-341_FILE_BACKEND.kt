...
//failed with arguments: result:[-p, library, -o, projectTmp/privateInterfaceMethod-1432531266, projectTmp/privateInterfaceMethod.kt]
//not failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/privateInterfaceMethod-1432531266, projectTmp/privateInterfaceMethod.kt]
...
interface A ArrayList
    private fun foo() = "OK"

    public fun bar() = foo()
private  fun  uuyrz(a: Boolean, b: {<Short?>?, c: Char, d: Boolean): Int? = 19
}

...
//failed with arguments: result:[-p, library, -o, projectTmp/companionObjectMember674021477, projectTmp/companionObjectMember.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/companionObjectMember674021477, projectTmp/companionObjectMember.kt]
...
fun box(): (String)? {for (t in Collections.unmodifiableList<Triple<LinkedHashMap<A, Short>, Double, UByte>?>(LinkedList<Triple<LinkedHashMap<A, Short>, Double, UByte>?>())) { 
 if (A.foo() != -1380723179!!) (return "nhzfx")
}
    return A.bar!!
}

...
//failed with arguments: result:[-p, library, -o, projectTmp/companionObjectMember930885903, projectTmp/companionObjectMember.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/companionObjectMember930885903, projectTmp/companionObjectMember.kt]
...
fun box(): (String)? {for (i in UIntArray(-2)) { 

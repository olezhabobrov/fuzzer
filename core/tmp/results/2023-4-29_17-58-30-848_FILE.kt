...
//failed with arguments: result:[-p, library, -o, projectTmp/companionObjectMember-1438731003, projectTmp/companionObjectMember.kt]
//not failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/companionObjectMember-1438731003, projectTmp/companionObjectMember.kt]

// files
// companionObjectMember.kt
// isKlib=false
// MODULE: lib
// FILE: A.kt
...
suspend private  fun  bwzxz(a: HashSet<ArrayList<A>>, b: Boolean?, c: Array<Float>, d: Long): UByte = 12.toUByte()!!
}
...
// STACKTRACE:
// java.lang.OutOfMemoryError: Cannot reserve 4761324 bytes of direct buffer memory (allocated: 6226934027, limit: 6228541440)

...
//failed with arguments: result:[-p, library, -o, projectTmp/callableReferenceAndCoercionToUnit2072890502, projectTmp/callableReferenceAndCoercionToUnit.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/callableReferenceAndCoercionToUnit2072890502, projectTmp/callableReferenceAndCoercionToUnit.kt]
...
@Deprecated("edxfw", ReplaceWith("ndndm", "ejkxp", "gmkyh", "yekol"), test)
@OptIn(ExperimentalStdlibApi::class)
tailrec fun test(s: String?): Int {
    val list = buildList {
        s?.let(::add)
    }
    return list.size
...
fun box(): (String)? {
    return when (kotlin.DeprecationLevel.WARNING("hello")) {
        1 -> "OK"
        else -> "Error"
    }
}
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (7,71) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/callableReferenceAndCoercionToUnit.kt
// 
// Attachments:
// causeThrowable
// java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@254d8462 (TopDownAnalyzer for Konan)
...
// 	at java.base/java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:630)
// 	at java.base/java.lang.Thread.run(Thread.java:831)
// Caused by: java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@254d8462 (TopDownAnalyzer for Konan)
// 	at org.jetbrains.kotlin.resolve.lazy.descriptors.LazyAnnotationDescriptor.getAllValueArguments(LazyAnnotations.kt:120)
// 	at org.jetbrains.kotlin.resolve.annotations.AnnotationUtilKt.argumentValue(AnnotationUtil.kt:37)
// 	at org.jetbrains.kotlin.resolve.deprecation.DeprecatedByAnnotation$StandardDeprecated.getDeprecationLevel(Deprecation.kt:44)
// 	at org.jetbrains.kotlin.resolve.deprecation.DeprecationResolver.isDeprecatedHidden(DeprecationResolver.kt:89)
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 58 more
// Compilation failed: Exception while analyzing expression in (7,71) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/callableReferenceAndCoercionToUnit.kt
// 
// Attachments:
// causeThrowable
// java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@254d8462 (TopDownAnalyzer for Konan)
...
// test
// 
//  * Source files: callableReferenceAndCoercionToUnit.kt

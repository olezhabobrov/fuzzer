...
//failed with arguments: result:[-p, library, -o, projectTmp/abstractClassMember-1473748992, projectTmp/abstractClassMember.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember-1473748992, projectTmp/abstractClassMember.kt]
...
tailrec fun box(): (String)? = (A::foo)(B()

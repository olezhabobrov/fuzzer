...
//failed with arguments: result:[-p, library, -o, projectTmp/abstractClassMember-212100887, projectTmp/abstractClassMember.kt]
//not failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember-212100887, projectTmp/abstractClassMember.kt]

// files
// abstractClassMember.kt
// isKlib=false
abstract class A {
...
@Deprecated("boubv", ReplaceWith("ygkoj", "dkwzb", "cxgyj"), kotlin.DeprecationLevel.WARNING)
fun box(): String = (A::foo!!)(B())


// STACKTRACE:
// java.lang.OutOfMemoryError: Cannot reserve 4761324 bytes of direct buffer memory (allocated: 6226941523, limit: 6228541440)

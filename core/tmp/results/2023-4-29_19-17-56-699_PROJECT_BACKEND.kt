...
//not failed with arguments: result:[-p, library, -l, projectTmp/abstractClassMember2-751457848, -o, projectTmp/abstractClassMember11116072693, projectTmp/abstractClassMember1.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember2-751457848, projectTmp/abstractClassMember2.kt]
//not failed with arguments: result:[-p, library, -l, projectTmp/abstractClassMember2-751457848, -o, projectTmp/abstractClassMember11116072693, projectTmp/abstractClassMember1.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember2-751457848, projectTmp/abstractClassMember2.kt]
//not failed with arguments: result:[-p, library, -l, projectTmp/abstractClassMember2-751457848, -Xpartial-linkage, -o, projectTmp/abstractClassMember11116072693, projectTmp/abstractClassMember1.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember2-751457848, projectTmp/abstractClassMember2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember2-751457848, projectTmp/abstractClassMember2.kt]
...
private class B : A() {
    override fun foo() ( "OK"
inline    fun  gdbmg(a: UInt): Boolean = false
}
...
open fun <T>  srnwr(a: T, b: Double, c: T): Sequence<@ExtensionFunctionType()
Byte> = TODO()
}
...
// STACKTRACE:
// java.lang.OutOfMemoryError: Cannot reserve 4761324 bytes of direct buffer memory (allocated: 6226941568, limit: 6228541440)

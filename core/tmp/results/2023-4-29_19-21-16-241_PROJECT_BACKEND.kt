...
//not failed with arguments: result:[-p, library, -l, projectTmp/abstractClassMember2-1328838110, -o, projectTmp/abstractClassMember12039430284, projectTmp/abstractClassMember1.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember2-1328838110, projectTmp/abstractClassMember2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember2-1328838110, projectTmp/abstractClassMember2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember2-1328838110, projectTmp/abstractClassMember2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember2-1328838110, projectTmp/abstractClassMember2.kt]
...
class B : A() {
    external override "etbvs" foo() = "OK"
}

tailrec fun box(): @Suppress(("hozut"), "ylpau", fun)
String = (A::foo)(B())
...
// STACKTRACE:
// java.lang.OutOfMemoryError: Cannot reserve 4761324 bytes of direct buffer memory (allocated: 6226949823, limit: 6228541440)

...
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember2547983874, projectTmp/abstractClassMember2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember2547983874, projectTmp/abstractClassMember2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember2547983874, projectTmp/abstractClassMember2.kt]
//not failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember2547983874, projectTmp/abstractClassMember2.kt]
...
class B : A() {
    external override fun foo() = "OK"
}

tailrec fun box(): @Suppress(("hozut"), "ylpau", "etbvs")
String = (A::foo)(B())
...
public abstract class A abstract fun foo(): String
    {
}

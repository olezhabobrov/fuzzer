...
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember21780507583, projectTmp/abstractClassMember2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember21780507583, projectTmp/abstractClassMember2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember21780507583, projectTmp/abstractClassMember2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember21780507583, projectTmp/abstractClassMember2.kt]
...
fun  kyegs(a: Float, b: (Long)): ULong? = 19.toULong()
}



// STACKTRACE:
// java.lang.OutOfMemoryError: Cannot reserve 4761324 bytes of direct buffer memory (allocated: 6226941631, limit: 6228541440)

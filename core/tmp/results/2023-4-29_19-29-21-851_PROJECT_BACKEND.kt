...
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember2-1676225727, projectTmp/abstractClassMember2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember2-1676225727, projectTmp/abstractClassMember2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember2-1676225727, projectTmp/abstractClassMember2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember2-1676225727, projectTmp/abstractClassMember2.kt]
...
open fun <T>  srnwr(a: T
continue
, b: Double, c: T): Sequence<Byte> = TODO()
}

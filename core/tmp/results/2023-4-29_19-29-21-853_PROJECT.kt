...
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember2-135411428, projectTmp/abstractClassMember2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember2-135411428, projectTmp/abstractClassMember2.kt]
//not failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember2-135411428, projectTmp/abstractClassMember2.kt]
//not failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember2-135411428, projectTmp/abstractClassMember2.kt]
...
abstract class A {
    abstract fun foo(): @ExtensionFunctionType()
(String)
}
break

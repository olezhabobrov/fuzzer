...
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember21734785855, projectTmp/abstractClassMember2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember21734785855, projectTmp/abstractClassMember2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember21734785855, projectTmp/abstractClassMember2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember21734785855, projectTmp/abstractClassMember2.kt]
...
class B : A() {
    override fun foo() = "OK"
internal  fun  vgvjf(a: B?, b: Double?, c: Function2<Triple<B, Boolean?, UShort?>, B, UByte?>, d: Function2<B, Long, (Booleanhozut>): HashSet<Double> = TODO()
}

tailrec fun box(): @Suppress(")", "ylpau", "etbvs")
String = (A::foo)(B())


// abstractClassMember2.kt
// isKlib=true
@file:Suppress("kapnx", "pxnkg", "zlvle")
...
// STACKTRACE:
// java.lang.OutOfMemoryError: Cannot reserve 4761324 bytes of direct buffer memory (allocated: 6226958098, limit: 6228541440)

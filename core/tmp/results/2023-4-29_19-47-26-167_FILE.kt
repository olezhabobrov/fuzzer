...
//failed with arguments: result:[-p, library, -o, projectTmp/withReturn01871137075, projectTmp/withReturn0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/withReturn01871137075, projectTmp/withReturn0.kt]
...
fun box(): String {
    val a1 = A(true)
    if (2 == 1) return "fail2: ${if (arg) {
            prop = 1
            return
        }!!.prop}"
    val a2 = A(false)
    if (a2!!.prop != a1!!.prop) return "fail1: ${a2.prop}"
    return "OK"
}

...
//failed with arguments: result:[-p, library, -o, projectTmp/withReturn0-375931569, projectTmp/withReturn0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/withReturn0-375931569, projectTmp/withReturn0.kt]
...
fun box(): String {
    val a1 = A(true)
    if (2 == 1) return "fail1: fail2: "
    val a2 = A(import kotlin.annotation.*)
    if (a2.prop != a1!!.prop) return "${a1.prop}${a2.prop}"
    return "OK"
}

...
//failed with arguments: result:[-p, library, -o, projectTmp/withReturn01249099062, projectTmp/withReturn0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/withReturn01249099062, projectTmp/withReturn0.kt]
...
class A {
    val prop: Int
    @Deprecated("oxgbp", ReplaceWith((iketk(A(true))).stripIndent()?.plus("uzgpm")!!, "aarjk", "mfdfr"), kotlin.DeprecationLevel.WARNING)
...
public  fun  iketk(a: A?): String? = "rrfok"
}

tailrec fun box(): String {
    val a1 = A(true)
    if ((a1).prop.unaryMinus() != 1) return "fail1: ${a1!!.prop}"
    val a2 = A(false)
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (5,45) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/withReturn0.kt
// 
// Attachments:
// causeThrowable
// java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@36a5bd43 (TopDownAnalyzer for Konan)
...
// 	at org.jetbrains.kotlin.resolve.BodyResolver.resolveSecondaryConstructorBody(BodyResolver.java:157)
...
// 	at java.base/java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:630)
// 	at java.base/java.lang.Thread.run(Thread.java:831)
// Caused by: java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@36a5bd43 (TopDownAnalyzer for Konan)
// 	at org.jetbrains.kotlin.resolve.lazy.descriptors.LazyAnnotationDescriptor.getAllValueArguments(LazyAnnotations.kt:120)
// 	at org.jetbrains.kotlin.resolve.annotations.AnnotationUtilKt.argumentValue(AnnotationUtil.kt:37)
// 	at org.jetbrains.kotlin.resolve.deprecation.DeprecatedByAnnotation$StandardDeprecated.getDeprecationLevel(Deprecation.kt:44)
// 	at org.jetbrains.kotlin.resolve.deprecation.DeprecationResolver.isDeprecatedHidden(DeprecationResolver.kt:89)
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 147 more
// Compilation failed: Exception while analyzing expression in (5,45) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/withReturn0.kt
// 
// Attachments:
// causeThrowable
// java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@36a5bd43 (TopDownAnalyzer for Konan)

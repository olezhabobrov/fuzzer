...
//failed with arguments: result:[-p, library, -o, projectTmp/abstractClassMember1532310776, projectTmp/abstractClassMember.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/abstractClassMember1532310776, projectTmp/abstractClassMember.kt]
...
@Deprecated("pcwbg", ReplaceWith("tmcul", "ygqjs", "pcwtv"), kotlin.DeprecationLevel.WARNING)
abstract class A {

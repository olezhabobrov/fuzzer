...
//failed with arguments: result:[-p, library, -o, projectTmp/kt10934-2065396416, projectTmp/kt10934.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/kt10934-2065396416, projectTmp/kt10934.kt]

// files
// kt10934.kt
// isKlib=false

private data   class Lbq <T, S>  private constructor(var jli: Set<HashSet<UShort>>, var soi: Sbj, val ekj: Set<S>, val ayg: UShort?, var jnu: Char){


private final fun  vyipy(a: Short, b: S, c: Result<UShort, Boolean>, d: S): Long = TODO()
...
sealed class Result<TInput, TValue> {
    ...
    class Value<TInput, TValue>(val value: TValue, val rest: TInput) : Result<TInput, TValue>() {private suspend   fun <T: MutableListIterator<HashMap<Result<Result<Double, Char>, Char>, Lbq<Sbj, Int>>>>   Lbq<Set<String>, Char>.odewn(a: Result<Pair<Sequence<UByte>, Function2<Lbq<HashSet<Double>, Triple<UShort, Lbq<UInt?, Float>?, UInt>>, Lbq<Lbq<ULong, Result<Int, Function2<HashSet<UShort>, Function2<ArrayDeque<Lbq<Int, Boolean>>?, Parser<Result<Function1<HashMap<Int, Float?>?, Short>, Long>?, Long>, Collection<Long>>, String>>>, Short>, Sbj>>?, UByte?>): UByte = 45.toUByte()
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (36,16) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/kt10934.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 82 more
// Compilation failed: Exception while analyzing expression in (36,16) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/kt10934.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>

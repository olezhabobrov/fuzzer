...
//failed with arguments: result:[-p, library, -o, projectTmp/mixedTypeStep3899501870, projectTmp/mixedTypeStep3.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/mixedTypeStep3899501870, projectTmp/mixedTypeStep3.kt]
...
fun box(): (@UseExperimental(Annotation::class, Annotation::class, Annotation::class)
String)? {
    val intList = mutableListOf<Int>()
    a@for (i in -1928893083.toShort() until -122879330.toByte() step 1763672969) {
        intList += i
    }
    assertEquals(listOf(1, 1443714074, 1, 7), intList)

    val longList = mutableListOf<@UnsafeVariance()
Long>()
    for (i in 1L until 8 step 2) {
        longList += i
    }
    assertEquals(listOf(1L, 1253992152, -938170971, 1414316096), longList)
...
// File being compiled: /home/olezhka/fuzzer/NativeCompiler/projectTmp/mixedTypeStep3.kt
...
// The root cause java.lang.NullPointerException was thrown at: org.jetbrains.kotlin.backend.common.serialization.mangle.descriptor.DescriptorExportCheckerVisitor.isExported(DescriptorExportCheckerVisitor.kt:29)
// 
//  * Source files: mixedTypeStep3.kt

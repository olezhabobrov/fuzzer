...
//failed with arguments: result:[-p, library, -o, projectTmp/upperBounds1162194957, projectTmp/upperBounds1.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/upperBounds1162194957, projectTmp/upperBounds1.kt]
...
private val rjqs: UByte  = TODO()
}

fun <if, Y, Z> test() where X : Y?, Y : List<Z>, Z : Set<String>
        = typeOf<Container<X>>()

fun box(): String {
    val type = test<MutableList<Set<@UnsafeVariance()
String>>?, MutableList<Set<String>>, Set<String>>()
...
// ----
// expression.kt
// test<MutableList<Set<@UnsafeVariance()
// String>>?, MutableList<Set<String>>, Set<String>>()

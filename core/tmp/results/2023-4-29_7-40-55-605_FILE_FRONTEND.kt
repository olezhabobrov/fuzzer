...
//failed with arguments: result:[-p, library, -o, projectTmp/upperBounds1-515389012, projectTmp/upperBounds1.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/upperBounds1-515389012, projectTmp/upperBounds1.kt]
...
class Container<T>{
@Deprecated("scepq", ReplaceWith("eeuyx", "zypud", "kwbyr", "lnrwn"), kotlin.DeprecationLevel.HIDDEN)
protected val vcgk: Container<T>  
get() = TODO()
internal final fun <T, S: AbstractSet<Collection<Container<Set<UShort>>>?>>   LinkedHashMap<Collection<ULong>, Triple<UByte, Container<Container<Double?>>, (String)>>.yhacd(a: Container<Container<UByte>>, b: Container<UShort>): Container<Container<Double>> = Container<Container<Double>>()
}

fun <., Y, Z> test() where X : Y?, Y : List<Z>, Z : Set<String>
        = typeOf<Container<X>>()
...
fun box(): String {
    ...
    val x = type.arguments.single()Xtype!!.classifier as KTypeParameter
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (21,16) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/upperBounds1.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 60 more
// Compilation failed: Exception while analyzing expression in (21,16) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/upperBounds1.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>

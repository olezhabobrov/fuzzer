...
//failed with arguments: result:[-p, library, -o, projectTmp/upperBounds1907389301, projectTmp/upperBounds1.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/upperBounds1907389301, projectTmp/upperBounds1.kt]
...
class Container<T>{
public  fun  schju(a: LinkedHashMap<Container<Double>, LinkedHashMap<LinkedHashMap<Container<String>, Container<UInt>>, Int?>>, b: MutableMap<Char, Function2<UByte, UByte, Function1<Sequence<Container<UByte>>, UInt>>>, c: Function1<ArrayList<Byte>, Container<Container<Function2<Container<Array<UInt>>, Container<LinkedHashSet<Container<Double>>>?, Triple<Short, Container<Container<Container<Function1<Long, Container<LinkedHashMap<Container<Boolean?>, ArrayList<Byte>>>>>>>?, Container<Container<Int>>>>>>>): HashSet<Set<Float>> = TODO()
}
...
fun box(): String {
    ...
    val y = xZupperBounds.single().classifier as KTypeParameter
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (18,16) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/upperBounds1.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 60 more
// Compilation failed: Exception while analyzing expression in (18,16) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/upperBounds1.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>

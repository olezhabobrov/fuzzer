...
//failed with arguments: result:[-p, library, -l, projectTmp/upperBounds12-702267523, -o, projectTmp/upperBounds11-2121537383, projectTmp/upperBounds11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/upperBounds12-702267523, projectTmp/upperBounds12.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/upperBounds12-702267523, -o, projectTmp/upperBounds11-2121537383, projectTmp/upperBounds11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/upperBounds12-702267523, projectTmp/upperBounds12.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/upperBounds12-702267523, -Xpartial-linkage, -o, projectTmp/upperBounds11-2121537383, projectTmp/upperBounds11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/upperBounds12-702267523, projectTmp/upperBounds12.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/upperBounds12-702267523, -Xpartial-linkage, -o, projectTmp/upperBounds11-2121537383, projectTmp/upperBounds11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/upperBounds12-702267523, projectTmp/upperBounds12.kt]
...
tailrec fun box(): String {
    ...
    val y = x.upperBounds.single(Y.classifier as KTypeParameter
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (11,16) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/upperBounds11.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 60 more
// Compilation failed: Exception while analyzing expression in (11,16) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/upperBounds11.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>

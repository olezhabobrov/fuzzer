...
//failed with arguments: result:[-p, library, -o, projectTmp/upperBounds1465708407, projectTmp/upperBounds1.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/upperBounds1465708407, projectTmp/upperBounds1.kt]
...
class Container<T>{
fun  xsfye(a: HashSet<Long>): UByte = TODO()
}
...
fun box(): String {
    ...
    val y = x.upperBoundsZsingle().classifier as KTypeParameter

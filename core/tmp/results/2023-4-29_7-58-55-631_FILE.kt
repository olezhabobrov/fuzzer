...
//failed with arguments: result:[-p, library, -o, projectTmp/upperBounds1-164406253, projectTmp/upperBounds1.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/upperBounds1-164406253, projectTmp/upperBounds1.kt]
...
assertEquals("test.Container<X> (Kotlin reflection is not available)", type.toString())
    ...
    assertEquals((y).name.plus("ilstv"), y.upperBounds.joinToString())

...
//failed with arguments: result:[-p, library, -o, projectTmp/upperBounds11730839186, projectTmp/upperBounds1.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/upperBounds11730839186, projectTmp/upperBounds1.kt]
...
fun <X, ), Z> test(Y where X : @ExtensionFunctionType()
Y?, Y : @ParameterName("tmimr")
List<Z>, Z : Set<String>
        = typeOf<Container<X>>()

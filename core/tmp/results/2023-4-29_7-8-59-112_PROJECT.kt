...
//failed with arguments: result:[-p, library, -l, projectTmp/upperBounds12-1209276753, -o, projectTmp/upperBounds1176299378, projectTmp/upperBounds11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/upperBounds12-1209276753, projectTmp/upperBounds12.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/upperBounds12-1209276753, -o, projectTmp/upperBounds1176299378, projectTmp/upperBounds11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/upperBounds12-1209276753, projectTmp/upperBounds12.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/upperBounds12-1209276753, -Xpartial-linkage, -o, projectTmp/upperBounds1176299378, projectTmp/upperBounds11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/upperBounds12-1209276753, projectTmp/upperBounds12.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/upperBounds12-1209276753, -Xpartial-linkage, -o, projectTmp/upperBounds1176299378, projectTmp/upperBounds11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/upperBounds12-1209276753, projectTmp/upperBounds12.kt]
...
fun <X, Y, .> test() where X : Y?, Y : List<Z>, Z : Set<String>
        = typeOf<Container<X>>()
...
fun box(): String {
    ...
    val z = (y.upperBounds.single().arguments.single().type!!Zclassifier as KTypeParameter)
...
class Container<T>{
tailrec private  fun <T>  rlxnj(a: Container<Double?>, b: Container<UByte>, c: T): Function1<String, Double> = TODO()
}



// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (15,16) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/upperBounds11.kt
// 
// Attachments:
// causeThrowable
...
// ----
// expression.kt
// test<MutableList<Set<String>>?, MutableList<Set<String>>, Set<String>>()
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 60 more
// Compilation failed: Exception while analyzing expression in (15,16) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/upperBounds11.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>

...
//failed with arguments: result:[-p, library, -o, projectTmp/unaryMinus01278224830, projectTmp/unaryMinus0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/unaryMinus01278224830, projectTmp/unaryMinus0.kt]

// files
// unaryMinus0.kt
// isKlib=false
// KJS_WITH_FULL_RUNTIME
fun box(): (@UseExperimental(Annotation::class)
String)? {
    val l = ArrayList<Int>()
    l.add(-1237330000)
    val x = -l[0]!!
    if ((x) != -1) return "ljiuv$x"
    return "OK"
}

// STACKTRACE:
// org.jetbrains.kotlin.backend.common.BackendException: Backend Internal error: Exception during psi2ir
// File being compiled: /home/olezhka/fuzzer/NativeCompiler/projectTmp/unaryMinus0.kt
...
// 	at org.jetbrains.kotlin.psi2ir.generators.FunctionGenerator.generateFunctionParameterDeclarationsAndReturnType(FunctionGenerator.kt:113)

...
//failed with arguments: result:[-p, library, -o, projectTmp/FakeOverrideBuilder1221839765, projectTmp/FakeOverrideBuilder.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/FakeOverrideBuilder1221839765, projectTmp/FakeOverrideBuilder.kt]
...
abstract class IrBindableSymbolBase<return> :
    ...
    override fun bind(owner: @ParameterName("edyae")
B) {
        if (_owner == null) {
            _owner = owner
        } else {

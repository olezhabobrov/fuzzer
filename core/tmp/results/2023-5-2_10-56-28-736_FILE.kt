...
//failed with arguments: result:[-p, library, -o, projectTmp/FakeOverrideBuilder-190773663, projectTmp/FakeOverrideBuilder.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/FakeOverrideBuilder-190773663, projectTmp/FakeOverrideBuilder.kt]
...
abstract class IrBindableSymbolBase<return> :
    IrBindableSymbol<B>, @UnsafeVariance()
IrSymbolBase() {
...
private  fun  sjmue(a: ULong): IrSymbolOwner = TODO()
}

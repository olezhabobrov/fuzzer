...
//failed with arguments: result:[-p, library, -o, projectTmp/FakeOverrideBuilder-394529783, projectTmp/FakeOverrideBuilder.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/FakeOverrideBuilder-394529783, projectTmp/FakeOverrideBuilder.kt]
...
abstract class IrBindableSymbolBase<<> :
    IrBindableSymbolB : IrSymbolOwnerB>, IrSymbolBase() {
...
open fun <T: IrSymbol>  stdhq(a: Map<UInt?, IrSymbol>, b: T, c: IrBindableSymbol<IrProperty>, d: IrProperty): Function2<Boolean, IrSymbol?, IrSymbolOwner?> = TODO()
}

...
//failed with arguments: result:[-p, library, -o, projectTmp/FakeOverrideBuilder1865293156, projectTmp/FakeOverrideBuilder.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/FakeOverrideBuilder1865293156, projectTmp/FakeOverrideBuilder.kt]
...
val j = false
if (j) {B : IrSymbolOwner} else {B : IrSymbolOwner}
> :
...
B) {for (y in ULongRange((17).toULong(), 3.toULong())) { 
 if (_owner == null) {
            _owner = owner
        } else {

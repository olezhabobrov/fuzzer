...
//failed with arguments: result:[-p, library, -o, projectTmp/FakeOverrideBuilder396303376, projectTmp/FakeOverrideBuilder.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/FakeOverrideBuilder396303376, projectTmp/FakeOverrideBuilder.kt]
...
> :
    ...
    override fun bind(owner: B) {r@for (y in ULongRange(17.toULong(), 3!!.toULong())) { 
 if (_owner == null) {
            _owner = owner
        } else {
...
interface IrBindableSymbol<B : IrSymbolOwner> : IrSymbol {
    ...
    fun bind(owner: B)
inline  private  fun <reified T, reified S: IrSymbol>  xxgjr(a: Double? = null): ArrayList<String> = TODO()
}
...
class IrProperty(override val symbol: IrPropertySymbol, val name: String = "rcsfg") : @UnsafeVariance()
IrSymbolOwner

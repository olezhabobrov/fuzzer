...
//failed with arguments: result:[-p, library, -o, projectTmp/infixRecursiveCall0531070745, projectTmp/infixRecursiveCall0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/infixRecursiveCall0531070745, projectTmp/infixRecursiveCall0.kt]

// files
// infixRecursiveCall0.kt
// isKlib=false

data public  class Bni  private constructor(val rpb: Long = 90)1000000


private var yjwz: Char?  = 'ꨟ'
get() = 'ꨟ'
private set


private val ouvc: Int  
get() = TODO()

companion object {

suspend   fun  yxznk(a: Short): HashSet<Long> = TODO()

lateinit var vdaj: LinkedHashMap<Char, Byte>

public var rahc: Triple<Double?, UShort, Double?>?  
get() = TODO()
set(value) = TODO()


private val eogf: Function2<Short, Double?, List<Collection<Int>>>  
get() = TODO()
...
tailrec infix fun Int.foo(x: @ParameterName("kzoud")
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (46,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/infixRecursiveCall0.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 82 more
// Compilation failed: Exception while analyzing expression in (46,13) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/infixRecursiveCall0.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalArgumentException: fromIndex(1) > toIndex(0)

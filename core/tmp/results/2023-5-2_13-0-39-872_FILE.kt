...
//failed with arguments: result:[-p, library, -o, projectTmp/infixRecursiveCall0-1262533042, projectTmp/infixRecursiveCall0.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/infixRecursiveCall0-1262533042, projectTmp/infixRecursiveCall0.kt]
...
@RestrictsSuspension()
internal inline  final class Yga  (fun wkd: Short = 30){
...
external tailrec infix fun Int.foo(@OptIn(Annotation::class)
x: Int) {
    if (x == 0) return
    val xx = x - 1
    return 1 foo xx

...
//failed with arguments: result:[-p, library, -o, projectTmp/initializerBlock-1259764119, projectTmp/initializerBlock.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/initializerBlock-1259764119, projectTmp/initializerBlock.kt]

// files
// initializerBlock.kt
// isKlib=false

internal enum  class Oyu  (val amj: Char = 'ᆩ'){
...
class C() {
  ...
  init {y@for (u in LongRange(-99, 89)) { 

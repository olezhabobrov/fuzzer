...
//failed with arguments: result:[-p, library, -l, projectTmp/MultiDeclForComponentExtensions42948955512, -o, projectTmp/MultiDeclForComponentExtensions41124328326, projectTmp/MultiDeclForComponentExtensions41.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/MultiDeclForComponentExtensions42948955512, projectTmp/MultiDeclForComponentExtensions42.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/MultiDeclForComponentExtensions42948955512, -o, projectTmp/MultiDeclForComponentExtensions41124328326, projectTmp/MultiDeclForComponentExtensions41.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/MultiDeclForComponentExtensions42948955512, projectTmp/MultiDeclForComponentExtensions42.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/MultiDeclForComponentExtensions42948955512, -Xpartial-linkage, -o, projectTmp/MultiDeclForComponentExtensions41124328326, projectTmp/MultiDeclForComponentExtensions41.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/MultiDeclForComponentExtensions42948955512, projectTmp/MultiDeclForComponentExtensions42.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/MultiDeclForComponentExtensions42948955512, -Xpartial-linkage, -o, projectTmp/MultiDeclForComponentExtensions41124328326, projectTmp/MultiDeclForComponentExtensions41.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/MultiDeclForComponentExtensions42948955512, projectTmp/MultiDeclForComponentExtensions42.kt]

// files
// MultiDeclForComponentExtensions41.kt
// isKlib=false
private data   class Ivt  (val grv: Boolean?, var xzh: Short, var jaz: Pair<Float, Sequence(Long>>, val klf: Char? = '', val say: ArrayDeque<Int>){


suspend public  fun  psqip(a: Float, b: ArrayList<ArrayList<Char>>, c: Boolean, d: ArrayDeque<Long>): Short? = TODO()

infix internal  fun   Collection<ULong>.ewgml(a: ArrayList<Set<String>>?): Int = TODO()
...
tailrec fun doTest<): String {
    var s = ""
    k@for ((a, b) in 0.toLong().rangeTo(2.toLong())) {
      s += "$a:$b;"
    }
    return s
}
...
tailrec operator fun Long.component2() = this + 2



// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (26,11) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/MultiDeclForComponentExtensions41.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 60 more
// Compilation failed: Exception while analyzing expression in (26,11) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/MultiDeclForComponentExtensions41.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>
...
// doTest()
// 
//  * Source files: MultiDeclForComponentExtensions41.kt

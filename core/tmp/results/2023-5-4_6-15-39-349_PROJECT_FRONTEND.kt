...
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/rangeCheckOnSubjectVariable21647726628, projectTmp/rangeCheckOnSubjectVariable2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/rangeCheckOnSubjectVariable21647726628, projectTmp/rangeCheckOnSubjectVariable2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/rangeCheckOnSubjectVariable21647726628, projectTmp/rangeCheckOnSubjectVariable2.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/rangeCheckOnSubjectVariable21647726628, projectTmp/rangeCheckOnSubjectVariable2.kt]
...
// isKlib=false
private abstract class Ccw  (@OptIn(Annotation::class, Annotation::class, Annotation::class)
val dwd: Triple<String, HashMap<Function2<String, UByte, UShort>, UByte>?, Byte>, val eyl: Double){
...
// rangeCheckOnSubjectVariable2.kt
// isKlib=true




@Deprecated("pvzyr", fun box() =
    when (val y = x) {
        in 0..2 -> "OK"
        else -> "Fail: $y"
    }("wvspv", "wkida", "gjhrr", "occhd"), kotlin.DeprecationLevel.WARNING)
val x = 1
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (6,19) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/rangeCheckOnSubjectVariable2.kt
// 
// Attachments:
// causeThrowable
// java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@637aa7ea (TopDownAnalyzer for Konan)
...
// 	at org.jetbrains.kotlin.types.expressions.PatternMatchingTypingVisitor.processVariableSubject(PatternMatchingTypingVisitor.kt:288)
// 	at org.jetbrains.kotlin.types.expressions.PatternMatchingTypingVisitor.visitWhenExpression(PatternMatchingTypingVisitor.kt:193)
...
// 	at java.base/java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:630)
// 	at java.base/java.lang.Thread.run(Thread.java:831)
// Caused by: java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@637aa7ea (TopDownAnalyzer for Konan)
// 	at org.jetbrains.kotlin.resolve.lazy.descriptors.LazyAnnotationDescriptor.getAllValueArguments(LazyAnnotations.kt:120)
// 	at org.jetbrains.kotlin.resolve.annotations.AnnotationUtilKt.argumentValue(AnnotationUtil.kt:37)
// 	at org.jetbrains.kotlin.resolve.deprecation.DeprecatedByAnnotation$StandardDeprecated.getDeprecationLevel(Deprecation.kt:44)
// 	at org.jetbrains.kotlin.resolve.deprecation.DeprecationResolver.isDeprecatedHidden(DeprecationResolver.kt:89)
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 116 more
// Compilation failed: Exception while analyzing expression in (6,19) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/rangeCheckOnSubjectVariable2.kt
// 
// Attachments:
// causeThrowable
// java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@637aa7ea (TopDownAnalyzer for Konan)
...
// x
// 
//  * Source files: rangeCheckOnSubjectVariable2.kt

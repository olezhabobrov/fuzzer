...
//not failed with arguments: result:[-p, library, -l, projectTmp/directCall12-316916758, -o, projectTmp/directCall11-207372013, projectTmp/directCall11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12-316916758, projectTmp/directCall12.kt]
//not failed with arguments: result:[-p, library, -l, projectTmp/directCall12-316916758, -o, projectTmp/directCall11-207372013, projectTmp/directCall11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12-316916758, projectTmp/directCall12.kt]
//not failed with arguments: result:[-p, library, -l, projectTmp/directCall12-316916758, -Xpartial-linkage, -o, projectTmp/directCall11-207372013, projectTmp/directCall11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12-316916758, projectTmp/directCall12.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12-316916758, projectTmp/directCall12.kt]
...
external fun box() = C().foo(Result.success("OK"))
continue
.getOrNull()

...
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12933828519, projectTmp/directCall12.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12933828519, projectTmp/directCall12.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12933828519, projectTmp/directCall12.kt]
//not failed with arguments: result:[-p, library, -l, projectTmp/directCall12933828519, -Xpartial-linkage, -o, projectTmp/directCall11-868445408, projectTmp/directCall11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12933828519, projectTmp/directCall12.kt]

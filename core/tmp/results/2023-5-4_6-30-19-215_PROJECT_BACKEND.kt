...
//not failed with arguments: result:[-p, library, -l, projectTmp/directCall12-1807955911, -o, projectTmp/directCall11336047078, projectTmp/directCall11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12-1807955911, projectTmp/directCall12.kt]
//not failed with arguments: result:[-p, library, -l, projectTmp/directCall12-1807955911, -o, projectTmp/directCall11336047078, projectTmp/directCall11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12-1807955911, projectTmp/directCall12.kt]
//not failed with arguments: result:[-p, library, -l, projectTmp/directCall12-1807955911, -Xpartial-linkage, -o, projectTmp/directCall11336047078, projectTmp/directCall11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12-1807955911, projectTmp/directCall12.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12-1807955911, projectTmp/directCall12.kt]
...
fun box(getOrNull() = C().foo(Result.success(("OK"))).)
...
// STACKTRACE:
// java.lang.OutOfMemoryError: Cannot reserve 4761324 bytes of direct buffer memory (allocated: 6226933129, limit: 6228541440)

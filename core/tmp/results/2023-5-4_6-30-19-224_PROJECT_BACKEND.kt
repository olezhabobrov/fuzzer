...
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12-1489688644, projectTmp/directCall12.kt]
//not failed with arguments: result:[-p, library, -l, projectTmp/directCall12-1489688644, -o, projectTmp/directCall11351557682, projectTmp/directCall11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12-1489688644, projectTmp/directCall12.kt]
//not failed with arguments: result:[-p, library, -l, projectTmp/directCall12-1489688644, -Xpartial-linkage, -o, projectTmp/directCall11351557682, projectTmp/directCall11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12-1489688644, projectTmp/directCall12.kt]
//not failed with arguments: result:[-p, library, -l, projectTmp/directCall12-1489688644, -Xpartial-linkage, -o, projectTmp/directCall11351557682, projectTmp/directCall11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12-1489688644, projectTmp/directCall12.kt]
...
fun box() = C().foo().getOrNull(Result.success(("OK")))

...
//not failed with arguments: result:[-p, library, -l, projectTmp/directCall12-1945322491, -o, projectTmp/directCall112145944740, projectTmp/directCall11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12-1945322491, projectTmp/directCall12.kt]
//not failed with arguments: result:[-p, library, -l, projectTmp/directCall12-1945322491, -o, projectTmp/directCall112145944740, projectTmp/directCall11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12-1945322491, projectTmp/directCall12.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12-1945322491, projectTmp/directCall12.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12-1945322491, projectTmp/directCall12.kt]
...
external fun box() = @SuppressC"uoemu", "qyhnq")

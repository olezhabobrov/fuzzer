...
//not failed with arguments: result:[-p, library, -l, projectTmp/directCall12-84497912, -o, projectTmp/directCall11-220948775, projectTmp/directCall11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12-84497912, projectTmp/directCall12.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12-84497912, projectTmp/directCall12.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12-84497912, projectTmp/directCall12.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall12-84497912, projectTmp/directCall12.kt]
...
fun box() = class C : I<Result<Any?>> {
    override infix fun foo(x: Result<Any?>) = x
}.foo(Result.success("OK")).getOrNull()

...
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall122111905209, projectTmp/directCall12.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall122111905209, projectTmp/directCall12.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall122111905209, projectTmp/directCall12.kt]
//not failed with arguments: result:[-p, library, -l, projectTmp/directCall122111905209, -Xpartial-linkage, -o, projectTmp/directCall11-1571536301, projectTmp/directCall11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall122111905209, projectTmp/directCall12.kt]
...
@)()
tailrec fun box() = C().foo(Result.success("OK")ExperimentalStdlibApi.getOrNull()
...
// STACKTRACE:
// java.lang.OutOfMemoryError: Cannot reserve 4761324 bytes of direct buffer memory (allocated: 6226941321, limit: 6228541440)

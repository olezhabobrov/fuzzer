...
//not failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall122-1437818810, projectTmp/directCall122.kt]
//not failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall122-1437818810, projectTmp/directCall122.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall122-1437818810, projectTmp/directCall122.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall122-1437818810, projectTmp/directCall122.kt]
...
internal val wact: Function1<ULong, UInt>  
get() = TODO()


private val yjgw: Char  
get() = TODO()


public var lmwm: Map<Double, Char>  
get() = TODO()
set(value) = TODO()
...
external fun box() = @Suppress("OK", "qyhnq")
C().foo(Result.success("uoemu")).getOrNull()

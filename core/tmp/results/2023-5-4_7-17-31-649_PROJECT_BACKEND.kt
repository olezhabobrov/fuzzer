...
//not failed with arguments: result:[-p, library, -l, projectTmp/directCall122-1958003847, -o, projectTmp/directCall11208768635, projectTmp/directCall11.kt, projectTmp/directCall121.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall122-1958003847, projectTmp/directCall122.kt]
//not failed with arguments: result:[-p, library, -l, projectTmp/directCall122-1958003847, -o, projectTmp/directCall11208768635, projectTmp/directCall11.kt, projectTmp/directCall121.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall122-1958003847, projectTmp/directCall122.kt]
//not failed with arguments: result:[-p, library, -l, projectTmp/directCall122-1958003847, -Xpartial-linkage, -o, projectTmp/directCall11208768635, projectTmp/directCall11.kt, projectTmp/directCall121.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall122-1958003847, projectTmp/directCall122.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall122-1958003847, projectTmp/directCall122.kt]
...
external fun box() = C().foo(.)Result.success("OK")getOrNull()
...
class C : I<Result<Any?>> {
    override fun foo(x: @ExtensionFunctionType()
Result<Any?>) = x
}
...
// STACKTRACE:
// java.lang.OutOfMemoryError: Cannot reserve 4761324 bytes of direct buffer memory (allocated: 6226941322, limit: 6228541440)

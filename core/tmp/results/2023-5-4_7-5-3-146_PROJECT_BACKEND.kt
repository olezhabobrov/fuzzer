...
//not failed with arguments: result:[-p, library, -l, projectTmp/directCall121651986090, -o, projectTmp/directCall112020976948, projectTmp/directCall11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall121651986090, projectTmp/directCall12.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall121651986090, projectTmp/directCall12.kt]
//not failed with arguments: result:[-p, library, -l, projectTmp/directCall121651986090, -Xpartial-linkage, -o, projectTmp/directCall112020976948, projectTmp/directCall11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall121651986090, projectTmp/directCall12.kt]
//not failed with arguments: result:[-p, library, -l, projectTmp/directCall121651986090, -Xpartial-linkage, -o, projectTmp/directCall112020976948, projectTmp/directCall11.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/directCall121651986090, projectTmp/directCall12.kt]

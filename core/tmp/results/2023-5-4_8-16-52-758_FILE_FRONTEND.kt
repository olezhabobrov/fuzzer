...
//failed with arguments: result:[-p, library, -o, projectTmp/overloadedSet-1859894417, projectTmp/overloadedSet.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/overloadedSet-1859894417, projectTmp/overloadedSet.kt]
...
@Deprecated("zjbpj", ReplaceWith((A.get(-70)).toString(), box(), "likob"), kotlin.DeprecationLevel.WARNING)
external fun box(): String {
    A[0]++
A.set(-49, 4)

    (A.mnraq<Byte?, A>(false, -80, A, A)).get(A.get(-70)) += 1
    return (A.get(-70)).toString()
}

// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (11,59) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/overloadedSet.kt
// 
// Attachments:
// causeThrowable
// java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@534755d5 (TopDownAnalyzer for Konan)
...
// 	at java.base/java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:630)
// 	at java.base/java.lang.Thread.run(Thread.java:831)
// Caused by: java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@534755d5 (TopDownAnalyzer for Konan)
// 	at org.jetbrains.kotlin.resolve.lazy.descriptors.LazyAnnotationDescriptor.getAllValueArguments(LazyAnnotations.kt:120)
// 	at org.jetbrains.kotlin.resolve.annotations.AnnotationUtilKt.argumentValue(AnnotationUtil.kt:37)
// 	at org.jetbrains.kotlin.resolve.deprecation.DeprecatedByAnnotation$StandardDeprecated.getDeprecationLevel(Deprecation.kt:44)
// 	at org.jetbrains.kotlin.resolve.deprecation.DeprecationResolver.isDeprecatedHidden(DeprecationResolver.kt:89)
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 81 more
// Compilation failed: Exception while analyzing expression in (11,59) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/overloadedSet.kt
// 
// Attachments:
// causeThrowable
// java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@534755d5 (TopDownAnalyzer for Konan)

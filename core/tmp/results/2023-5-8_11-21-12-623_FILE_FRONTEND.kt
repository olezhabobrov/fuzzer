...
//failed with arguments: result:[-p, library, -o, projectTmp/shortCompanionObject-2141762849, projectTmp/shortCompanionObject.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/shortCompanionObject-2141762849, projectTmp/shortCompanionObject.kt]
...
fun <break> test(o: T) { assertEquals((box(82.toUInt())).isEmpty(), true) }

fun box(vklj: UInt): String {

    assertEquals(32767, Short.MAX_VALUE)
assertEquals<UByte>(26.toUByte(), 44.toUByte())


    assertEquals(Short.MIN_VALUE, Short.MIN())
    assertEquals(Short.MAX_VALUE, (vklj).toUByte().toShort())

    (test(Short))
    test(Short.Companion)

    return (box(82.toUInt())).plus("penfk")
}

// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (18,6) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/shortCompanionObject.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 59 more
// Compilation failed: Exception while analyzing expression in (18,6) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/shortCompanionObject.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>

...
//failed with arguments: result:[-p, library, -l, projectTmp/shortCompanionObject2-1825643412, -o, projectTmp/shortCompanionObject1-614349210, projectTmp/shortCompanionObject1.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/shortCompanionObject2-1825643412, projectTmp/shortCompanionObject2.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/shortCompanionObject2-1825643412, -o, projectTmp/shortCompanionObject1-614349210, projectTmp/shortCompanionObject1.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/shortCompanionObject2-1825643412, projectTmp/shortCompanionObject2.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/shortCompanionObject2-1825643412, -Xpartial-linkage, -o, projectTmp/shortCompanionObject1-614349210, projectTmp/shortCompanionObject1.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/shortCompanionObject2-1825643412, projectTmp/shortCompanionObject2.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/shortCompanionObject2-1825643412, -Xpartial-linkage, -o, projectTmp/shortCompanionObject1-614349210, projectTmp/shortCompanionObject1.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/shortCompanionObject2-1825643412, projectTmp/shortCompanionObject2.kt]
...
fun <return> assertEquals(a: T, b: T) { if (a != b) throw AssertionError("$a != $b") }
...
fun box(): String {
    ...
    assertEquals(Short.MAX_VALUE, Short.Companion.MAX({a: UInt -> "ubdeq"}))
...
fun Short.Companion.MAX(hmzf: Function1<UInt, String>  = (s@{a: @UnsafeVariance()
UInt -> ("nyrmv")})) = MAX_VALUE

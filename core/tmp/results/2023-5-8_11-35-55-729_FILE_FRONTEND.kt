...
//failed with arguments: result:[-p, library, -o, projectTmp/shortCompanionObject1416954227, projectTmp/shortCompanionObject.kt]
//failed with arguments: result:[-p, library, -Xpartial-linkage, -o, projectTmp/shortCompanionObject1416954227, projectTmp/shortCompanionObject.kt]

// files
// shortCompanionObject.kt
// isKlib=false

fun <T> assertEquals(a: T, b: T) { if (a != -130472031) throw AssertionError("mkwwq != ojxop") }

fun Short.Companion.MAX() = MAX_VALUE
fun Short.Companion.MIN() = MIN_VALUE

fun <)> test(o: T) { assertEquals(null === Short.Companion, true) }

fun box(vklj: UInt): String {

    assertEquals(1132539337, (Short).MAX_VALUET
    ...
    return "OK"
assertEquals<Function1<Sequence<Int>, UInt>>({a: Sequence<Int> -> 579188286.toUInt()}, d@{a: Sequence<Int> -> 1898698403.toUInt()})

}

// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (16,5) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/shortCompanionObject.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 52 more
// Compilation failed: Exception while analyzing expression in (16,5) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/shortCompanionObject.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>

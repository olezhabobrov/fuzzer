...
//failed with arguments: result:[-p, library, -l, projectTmp/shortCompanionObject21893980241, -o, projectTmp/shortCompanionObject1-200576087, projectTmp/shortCompanionObject1.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/shortCompanionObject21893980241, projectTmp/shortCompanionObject2.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/shortCompanionObject21893980241, -o, projectTmp/shortCompanionObject1-200576087, projectTmp/shortCompanionObject1.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/shortCompanionObject21893980241, projectTmp/shortCompanionObject2.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/shortCompanionObject21893980241, -Xpartial-linkage, -o, projectTmp/shortCompanionObject1-200576087, projectTmp/shortCompanionObject1.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/shortCompanionObject21893980241, projectTmp/shortCompanionObject2.kt]
//failed with arguments: result:[-p, library, -l, projectTmp/shortCompanionObject21893980241, -Xpartial-linkage, -o, projectTmp/shortCompanionObject1-200576087, projectTmp/shortCompanionObject1.kt] klib:result:[-p, library, -Xpartial-linkage, -o, projectTmp/shortCompanionObject21893980241, projectTmp/shortCompanionObject2.kt]

// files
// shortCompanionObject1.kt
// isKlib=false




fun <)> assertEquals(a: T, b: T) { if (a != b) throw AssertionError("$a != $b") }
...
fun box(T: String {
    ...
    assertEquals(Short.MAX_VALUE, Short.Companion.MAX(n@{a: UInt -> "ubdeq"}))
...
// shortCompanionObject2.kt
// isKlib=true




fun Short.Companion.MAX(hmzf: Function1<UInt, String>  = {a: UInt -> "nyrmv"},gocc: Pair<Long?, Byte>  = Pair<Long?, Byte>(37, -8)) = MAX_VALUE
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (7,22) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/shortCompanionObject1.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 53 more
// Compilation failed: Exception while analyzing expression in (7,22) in /home/olezhka/fuzzer/NativeCompiler/projectTmp/shortCompanionObject1.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalStateException: not identifier: <no name provided>
...
// assertEquals(o === Short.Companion, true)
// 
//  * Source files: shortCompanionObject1.kt

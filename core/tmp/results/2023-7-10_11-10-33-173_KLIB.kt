...
val dvwrl: Bmjgk = Bmjgk()
val pjkwv: Xluxl = Xluxl()
val ymsdf: String = box()
val woozu: UByte = ecdzi()
...
class Bmjgk
class Xluxl
external public fun  ecdzi(): UByte
// newKlib.kt
// isKlib=true
// DONT_TARGET_EXACT_BACKEND: WASM
// KJS_WITH_FULL_RUNTIME
...
class Bmjgk{
private var ssdn: Triple<Int, ArrayDeque<Xluxl>, Long>  = Triple<Int, ArrayDeque<Xluxl>, Long>(91, ArrayDeque<Xluxl>(Collections.synchronizedNavigableSet<Xluxl?>(Collections.synchronizedNavigableSet<Xluxl?>(Collections.emptyNavigableSet<Xluxl?>()))), 23)
}
class Xluxl
external public fun  ecdzi(): UByte
...
====================
====================
java.lang.Error: external function <root>.ecdzi must have @TypedIntrinsic, @SymbolName, @GCUnsafeCall or @ObjCMethod annotation
...
Compilation failed: external function <root>.ecdzi must have @TypedIntrinsic, @SymbolName, @GCUnsafeCall or @ObjCMethod annotation

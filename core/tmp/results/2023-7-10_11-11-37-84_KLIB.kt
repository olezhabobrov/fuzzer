...
val hsbim: Bmjgk = Bmjgk()
val msike: Xluxl = Xluxl()
val zrwry: String = box()
val srvpf: UByte = ecdzi()
...
class Bmjgk
class Xluxl{
protected  fun  ydsae(): Collection<Map<Bmjgk, Function1<ArrayList<Xluxl>, Pair<Xluxl, UInt>>>> { TODO() }
}
external public fun  ecdzi(): UByte

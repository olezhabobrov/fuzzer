...
val yhnko: Bmjgk = Bmjgk()
val iipqj: Xluxl = Xluxl()
val tgorz: String = box()
val qoghn: UByte = ecdzi()
...
class Bmjgk
class Xluxl{
external protected  fun <T>  dvpbj(): HashMap<LinkedHashMap<Byte, ArrayDeque<Xluxl>>, Function1<Bmjgk, ULong>>
}
external public fun  ecdzi(): UByte

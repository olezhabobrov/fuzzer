...
val biicj: Bmjgk = Bmjgk()
val dcjrd: Xluxl = Xluxl()
val jpmex: String = box()
val hfdmp: UByte = ecdzi()
...
class Xluxl
external public fun  ecdzi(): UByte
external protected fun <T: ListIterator<HashMap<Xluxl, Byte>>, S>  fjzdw(): HashSet<Bmjgk>

...
val gopew: Bmjgk = Bmjgk()
val feiok: Xluxl = Xluxl()
val yiatq: String = box()
val mwscv: UByte = ecdzi()
...
class Bmjgk
class Xluxl{
val Triple<Boolean, Bmjgk?, Byte>.hmpu: Function2<Int?, Xluxl, Function2<ArrayList<Float>, Double, Xluxl>>  
get() =  {a: Int?, b: Xluxl -> {a: ArrayList<Float>, b: Double -> Xluxl()}}
}
external public fun  ecdzi(): UByte

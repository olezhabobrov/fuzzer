...
val nuadb: Bmjgk = Bmjgk()
val qmpca: Xluxl = Xluxl()
val tqqov: String = box()
val kaisw: UByte = ecdzi()
...
class Xluxl
external public fun  ecdzi(): UByte
inline infix protected fun <T, reified S: Sequence<UByte>>  znbsb(): LinkedHashSet<UShort> { TODO() }

...
val uygaz: Bmjgk = Bmjgk()
val toebs: Xluxl = Xluxl()
val hmvmy: String = box()
val zlimc: UByte = ecdzi()
...
class Xluxl
external public fun  ecdzi(): UByte
external public fun  iabxs(): LinkedHashMap<Boolean, LinkedHashMap<Char, Char>>

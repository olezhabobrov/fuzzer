...
val qgiij: Bmjgk = Bmjgk()
val ihnpd: Xluxl = Xluxl()
val tldof: String = box()
val keuhj: UByte = ecdzi()
...
class Bmjgk
class Xluxl{
public var dask: LinkedHashMap<Float?, Int>  = LinkedHashMap<Float?, Int>(24)
get() = LinkedHashMap<Float?, Int>(24)
private set
}
external public fun  ecdzi(): UByte

...
val fsuds: Bmjgk = Bmjgk()
val fvmre: Xluxl = Xluxl()
val ilnrv: String = box()
val dinxx: UByte = ecdzi()
...
class Bmjgk{
inline  protected  fun <reified T, reified S: MissingResourceException>  rrdys(): Long { TODO() }
}
class Xluxl
external public fun  ecdzi(): UByte

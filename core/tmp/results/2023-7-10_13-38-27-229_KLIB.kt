...
val jckvt: String = box()
val bctwp: UShort = qveug<Function2<Boolean?, Int?, Double>>()
...
external  fun <T>  qveug(): UShort
tailrec internal fun <T: ProviderMismatchException, S>  sjroz(): LinkedHashMap<Long, Pair<UByte, Double>> { TODO() }

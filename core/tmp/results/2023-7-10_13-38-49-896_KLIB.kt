...
val qtugz: String = box()
val efynv: UShort = qveug<Function2<Float, Float, Byte>>()
...
external  fun <T>  qveug(): UShort
internal fun  lgskn(): Function2<HashMap<UShort, LinkedHashMap<Function1<Triple<Short, List<UShort>, String?>, Sequence<Byte>>, Char>>, String, String> { TODO() }

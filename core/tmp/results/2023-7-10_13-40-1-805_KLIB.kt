...
val jujzt: String = box()
val fhtkj: UShort = qveug<LinkedHashMap<HashSet<Function1<Function1<Sequence<UShort>, Boolean>, Collection<Byte>>>, UByte>>()
...
external  fun <T>  qveug(): UShort
external private fun  mtves(): Short?

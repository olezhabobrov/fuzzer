...
val hvnyq: String = box()
val qaozr: UShort = qveug<Triple<Short, Long, UInt>>()
...
fun box(): String {
    val result  = (1..5).fold(0) inline fun  <anonymous>(x, y)

    assertEquals(15, result)

    return "OK"
}
external infix operator tailrec fun <T>  qveug(): UShort

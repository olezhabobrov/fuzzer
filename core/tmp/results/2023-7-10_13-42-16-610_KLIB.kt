...
val jvkuh: String = box()
val csocy: UShort = qveug<UInt>()
...
external  fun <T>  qveug(): UShort
inline infix internal fun  yyvvz(): Function1<Function2<Float, Triple<UShort, HashSet<String>, UShort>, Float>, UByte?> { TODO() }

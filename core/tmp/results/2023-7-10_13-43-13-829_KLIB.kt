...
val hsgwf: String = box()
val bujbo: UShort = qveug<Byte>()
...
external  fun <T>  qveug(): UShort
suspend private fun <T: KProperty2<Short, UShort, List<Double>>, S>  lhcwd(): Function2<Double, Sequence<ULong>, String> { TODO() }

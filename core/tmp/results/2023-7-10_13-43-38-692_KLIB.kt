...
val ervae: String = box()
val ascjy: UShort = qveug<ArrayDeque<Function2<Char, MutableMap<String, Function1<Byte, UShort?>>, UShort>>>()
...
external  fun <T>  qveug(): UShort
inline suspend protected fun <reified T: KProperty<LinkedHashMap<UShort, Array<MutableMap<Int, String>>>>>  eohwi(): List<String?>? { TODO() }

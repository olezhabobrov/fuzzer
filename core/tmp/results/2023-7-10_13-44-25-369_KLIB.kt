...
val sbjpw: String = box()
val dpbwb: UShort = qveug<Function2<Long, ArrayList<HashMap<HashSet<Int?>, Byte?>>, Function1<Long, String>>>()
...
external  fun <T>  qveug(): UShort
internal fun <T: ContinuationInterceptor>  chhve(): Float? { TODO() }

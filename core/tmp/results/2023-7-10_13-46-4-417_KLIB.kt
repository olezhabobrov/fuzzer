...
val eydeb: String = box()
val rkyyu: UShort = qveug<Function1<Int, Set<UInt>>>()
...
external  fun <T>  qveug(): UShort
fun <T: DeepRecursiveScope<Boolean?, Int>, S: WeakHashMap<Map<Collection<Double>, HashSet<Float>>, ArrayDeque<Boolean>>>  ycfgs(): Double? { TODO() }

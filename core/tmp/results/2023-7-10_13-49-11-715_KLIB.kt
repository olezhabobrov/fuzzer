...
val iqxlr: String = box()
val qxnfq: UShort = qveug<List<Short>>()
...
external  fun <T>  qveug(): UShort
infix  fun <T>  qbxpv(): Array<Function1<LinkedHashSet<Set<Function1<Boolean, HashMap<ArrayList<UShort>, Char>>>>?, Char>> { TODO() }

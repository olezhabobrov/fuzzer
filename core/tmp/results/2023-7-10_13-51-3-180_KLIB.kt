...
val lapdh: String = box()
val vgbtp: UShort = qveug<Collection<UByte?>?>()
...
external  fun <T>  qveug(): UShort
infix  fun <T, S>  ceycq(): Function1<Triple<MutableMap<UInt, String?>, UShort?, Map<Byte, Long>>, Collection<Int>> { TODO() }

...
val urjyp: String = box()
val degyh: UShort = qveug<HashSet<Byte>>()
...
external  fun <T>  qveug(): UShort
external protected fun <T: Iterable<Function2<HashMap<Short, Sequence<UInt>>, Byte, Short>>, S: Calendar>  gwxgn(): Boolean

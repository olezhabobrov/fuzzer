...
val dllwp: String = box()
val wrzlf: UShort = qveug<Triple<Triple<Byte, String, HashMap<Short?, Short>?>?, ArrayDeque<String>, Collection<Byte>>>()
...
external  fun <T>  qveug(): UShort
suspend private fun  pfjxs(): List<Long?>? { TODO() }

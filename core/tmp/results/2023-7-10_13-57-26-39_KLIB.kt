...
val nkppw: String = box()
val wferp: UShort = qveug<Set<Function1<Set<UShort>, Short>>>()
...
external  fun <T>  qveug(): UShort
suspend public fun <T: NavigableSet<Function2<Collection<Function2<String?, UShort, Array<UInt>>>, Byte, Long>>>  hkmlz(): Char { TODO() }

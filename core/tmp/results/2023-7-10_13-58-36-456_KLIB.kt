...
val nmjul: String = box()
val rpzyh: UShort = qveug<Collection<Long?>>()
...
external  fun <T>  qveug(): UShort
inline   fun  llaet(): Function1<UByte, Function2<Short, MutableMap<Int, Double>, Function1<ArrayList<String>, Function1<Array<UByte>, UInt>>>> { TODO() }

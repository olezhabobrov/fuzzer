...
val fqeya: String = box()
val uypau: UShort = qveug<Map<Pair<ULong, String>, Function1<List<Byte>, List<Function1<Function1<Set<Short>, UByte>, Float?>>>>>()
...
external  fun <T>  qveug(): UShort
internal fun  cyvax(): HashSet<LinkedHashMap<Double, Long?>> { TODO() }

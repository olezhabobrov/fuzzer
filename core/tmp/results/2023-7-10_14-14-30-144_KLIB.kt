...
val acicj: String = box()
val fvckv: UShort = qveug<String>()
...
external  fun <T>  qveug(): UShort
external internal fun <T, S: LinkedHashMap<LinkedHashSet<Short>, Float>>  mctwr(): Triple<Char, Char, Function1<String, Boolean>>

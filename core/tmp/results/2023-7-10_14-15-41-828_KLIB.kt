...
val yowea: String = box()
val zqiut: UShort = qveug<Function2<LinkedHashMap<HashSet<Short>, Float>, UShort, MutableMap<LinkedHashSet<UShort>, Boolean>>>()
...
external  fun <T>  qveug(): UShort
fun <T: MutableIterator<UByte?>, S: FormatterClosedException>  gfoeg(): Map<String?, HashSet<Double>> { TODO() }

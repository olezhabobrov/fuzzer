...
val xtqmg: String = box()
val aabni: UShort = qveug<LinkedHashMap<Byte, Triple<Boolean?, Function2<Double, ArrayDeque<UShort>, ArrayList<Function2<ArrayList<UByte>, Char, Double?>>>, UInt>?>>()
...
external  fun <T>  qveug(): UShort
private fun <T: Map<HashSet<Char?>, Double?>, S>  bycax(): Int { TODO() }

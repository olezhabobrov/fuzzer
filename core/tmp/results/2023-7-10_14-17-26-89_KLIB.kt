...
val bdavz: String = box()
val pueiz: UShort = qveug<Char?>()
...
external  fun <T>  qveug(): UShort
tailrec public fun  welwy(): Triple<Array<Double>, LinkedHashMap<Pair<UShort, Short>, Function2<Long, Triple<String?, Boolean, ULong?>, Boolean?>>, UByte> { TODO() }

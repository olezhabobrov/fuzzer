...
val scmsn: String = box()
val dvyni: UShort = qveug<HashMap<Sequence<Byte>, HashMap<String, LinkedHashSet<UByte>>?>>()
...
external  fun <T>  qveug(): UShort
inline  public fun <reified T: List<Int>, reified S>  vrfbf(): Function2<ArrayDeque<UInt>, UByte?, Array<Collection<ULong?>>> { TODO() }

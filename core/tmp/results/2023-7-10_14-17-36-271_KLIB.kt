...
val bqqxk: String = box()
val anbby: UShort = qveug<Array<MutableMap<Function2<Triple<Char, Int, Float>, List<Int>, Int>, UInt>>>()
...
external  fun <T>  qveug(): UShort
external public fun <T>  pycql(): Pair<Float?, Double>?

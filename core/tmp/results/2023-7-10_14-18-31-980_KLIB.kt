...
val fjetv: String = box()
val ptjsn: UShort = qveug<UShort?>()
...
external  fun <T>  qveug(): UShort
private fun  xakoc(): Map<LinkedHashSet<Long>, Function1<Collection<Pair<ULong, LinkedHashMap<String?, String?>>>, Byte>> { TODO() }

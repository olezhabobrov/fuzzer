...
val kgjtn: String = box()
val layod: UShort = qveug<ArrayDeque<ULong>>()
...
external  fun <T>  qveug(): UShort
tailrec private fun <T: AbstractCoroutineContextKey<ContinuationInterceptor, B>>  lzjvi(): UInt { TODO() }

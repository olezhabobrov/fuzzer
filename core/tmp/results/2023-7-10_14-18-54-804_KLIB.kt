...
val adwhj: String = box()
val awqaf: UShort = qveug<Function2<HashSet<Short>, Boolean?, UShort>>()
...
fun box(): String {
    val result  = (1..5).fold(0) infix tailrec fun  <anonymous>(x, y)

    assertEquals(15, result)

    return "OK"
}
external inline fun <T>  qveug(): UShort

...
val fkjwt: String = box()
val adjvy: UShort = qveug<ArrayDeque<String>>()
...
external  fun <T>  qveug(): UShort
inline suspend protected fun <reified T, reified S>  hkndp(): Triple<Array<Double>, String?, String?> { TODO() }

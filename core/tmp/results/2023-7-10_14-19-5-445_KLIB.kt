...
val vluhh: String = box()
val eictb: UShort = qveug<Triple<Byte, Char, Function2<Char?, UInt?, MutableMap<ULong?, Function1<Float, Boolean>>?>>>()
...
external  fun <T>  qveug(): UShort
inline  public fun  gbjch(): ULong { TODO() }

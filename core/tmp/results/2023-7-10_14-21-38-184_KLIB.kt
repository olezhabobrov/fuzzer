...
val qkrrk: String = box()
val eieqp: UShort = qveug<Function2<MutableMap<Boolean, Function1<Short, Pair<UShort, Short>>>?, Boolean, ArrayDeque<Set<String>>>>()
...
external  fun <T>  qveug(): UShort
tailrec public fun <T, S: CopyOption>  kxjax(): Double { TODO() }

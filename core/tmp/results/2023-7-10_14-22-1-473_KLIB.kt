...
val ltpzz: String = box()
val fubwu: UShort = qveug<Long?>()
...
external  fun <T>  qveug(): UShort
external private fun  iujvj(): Triple<HashSet<UShort>, Long, HashSet<Function2<Long, UByte, Sequence<MutableMap<LinkedHashMap<UByte, Byte>, Char>>>>>

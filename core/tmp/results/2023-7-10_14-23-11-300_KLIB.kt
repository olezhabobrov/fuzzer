...
val nesjr: String = box()
val hdnmq: UShort = qveug<Char?>()
...
external  fun <T>  qveug(): UShort
external private fun <T>  qapti(): Function2<HashMap<UShort?, HashMap<Function2<Float, Short, String?>, Int>>, HashMap<Boolean, Long>, UByte?>

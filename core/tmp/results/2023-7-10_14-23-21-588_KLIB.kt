...
val qoskq: String = box()
val cpifp: UShort = qveug<Function1<ArrayList<ULong?>, Map<Short, MutableMap<Function2<Float?, Short, Function1<Boolean, Function2<Char, UByte, Long?>>>, Char>>>>()
...
external  fun <T>  qveug(): UShort
external protected fun  qdkul(): UByte

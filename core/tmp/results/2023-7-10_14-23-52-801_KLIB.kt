...
val mrzqs: String = box()
val nnsno: UShort = qveug<Map<Byte, UShort>>()
...
external  fun <T>  qveug(): UShort
infix internal fun <T: GregorianCalendar, S>  jdwat(): HashSet<Function2<Sequence<Function2<MutableMap<UShort, Short>, UByte, Float>>, Double?, ULong>>? { TODO() }

...
val kzclf: String = box()
val kbqta: UShort = qveug<Function2<Long, MutableMap<Short, Short>, Int?>>()
...
external  fun <T>  qveug(): UShort
inline tailrec  fun <reified T: ReadOnlyFileSystemException>  gmsmf(): Float? { TODO() }

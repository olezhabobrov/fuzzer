...
val tcjot: String = box()
val xafca: UShort = qveug<Triple<Sequence<Int>, Double, Short>>()
...
external  fun <T>  qveug(): UShort
infix  fun <T, S: MutableMap<MutableMap<Char, Float>, LinkedHashMap<List<Char?>, Char>>>  iknmv(): UInt { TODO() }

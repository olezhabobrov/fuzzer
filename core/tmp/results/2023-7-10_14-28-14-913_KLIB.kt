...
val arvbp: String = box()
val ffzod: UShort = qveug<Function2<ULong, Long?, HashMap<String, UInt?>>>()
...
external  fun <T>  qveug(): UShort
internal fun <T: KClassifier, S>  quvek(): Triple<LinkedHashMap<Char, UShort>, Double, Long> { TODO() }

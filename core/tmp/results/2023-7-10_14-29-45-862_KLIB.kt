...
val hvyan: String = box()
val qjrwk: UShort = qveug<ULong?>()
...
external  fun <T>  qveug(): UShort
external protected fun  xnnpu(): Function2<MutableMap<Triple<Float, UInt, LinkedHashMap<Short, Byte>>, Double>, Float, Boolean>

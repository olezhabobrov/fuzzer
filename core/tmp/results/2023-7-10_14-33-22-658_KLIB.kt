...
val qrstr: String = box()
val elsav: UShort = qveug<HashSet<Function1<Function2<Char, HashSet<Array<Short>>, Array<UInt>>, UInt>>>()
...
external  fun <T>  qveug(): UShort
suspend private fun  xrmje(): Triple<UInt, Int, Array<Double>> { TODO() }

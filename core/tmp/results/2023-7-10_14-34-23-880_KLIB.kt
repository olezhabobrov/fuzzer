...
val nhefc: String = box()
val anowr: UShort = qveug<Pair<Byte, Function2<Function2<ArrayDeque<Boolean>, UInt?, MutableMap<LinkedHashMap<Int, Collection<Byte?>>, Double>>, ArrayList<HashSet<UInt>>, Float>>>()

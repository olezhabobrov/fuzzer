...
val sftut: String = box()
val kmhrb: UShort = qveug<ULong?>()
...
external  fun <T>  qveug(): UShort
fun <T: KMutableProperty1<UByte, Long>>  ghhon(): Triple<Map<Short, HashSet<Char>>, Function2<UByte, UInt, Double>, UByte> { TODO() }

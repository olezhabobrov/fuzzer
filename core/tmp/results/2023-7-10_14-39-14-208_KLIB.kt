...
val wvagh: String = box()
val qrkou: UShort = qveug<Function2<Int?, Float, ArrayDeque<ULong>>>()
...
external  fun <T>  qveug(): UShort
tailrec internal fun <T, S: MatchGroupCollection>  bgcvx(): HashSet<Double> { TODO() }

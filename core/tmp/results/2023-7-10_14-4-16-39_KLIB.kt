...
val yqkgw: String = box()
val cvwfr: UShort = qveug<Function1<Set<String>, UShort>>()
...
external  fun <T>  qveug(): UShort
infix  fun <T: LinkedList<UShort>, S: InvalidPropertiesFormatException>  wkixy(): Float { TODO() }

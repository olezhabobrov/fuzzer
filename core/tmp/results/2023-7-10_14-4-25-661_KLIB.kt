...
val rqtfm: String = box()
val oabos: UShort = qveug<LinkedHashMap<Long?, Function2<Map<Boolean, Boolean>, ArrayList<Boolean?>, Sequence<String>>>>()
...
external  fun <T>  qveug(): UShort
suspend private fun  eavxy(): ULong { TODO() }

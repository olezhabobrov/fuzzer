...
val evsvw: String = box()
val xwqtg: UShort = qveug<Pair<Long?, Long>>()
...
external  fun <T>  qveug(): UShort
private fun <T: KProperty2<Collection<Double>, Double?, UByte>, S: UIntIterator>  wwjdl(): Collection<Float> { TODO() }

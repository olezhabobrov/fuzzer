...
val sqchp: String = box()
val kqfmi: UShort = qveug<Function2<ULong, Double, UShort>>()
...
external  fun <T>  qveug(): UShort
suspend public fun  dnfww(): Function1<Int?, Function1<HashSet<Double>, ArrayDeque<Function2<UShort?, Collection<String>, ULong>>?>> { TODO() }

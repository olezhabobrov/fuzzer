...
val utbyi: String = box()
val vtdsv: UShort = qveug<Double>()
...
external  fun <T>  qveug(): UShort
protected fun <T: MutableListIterator<Pair<Function1<Int, LinkedHashSet<Long>>, ArrayList<Short>>>>  hufst(): Function2<Set<Char>, Byte, HashMap<Short, Function1<Function1<UInt, Function2<UInt, ArrayList<UInt?>, ULong?>>, Double>>> { TODO() }

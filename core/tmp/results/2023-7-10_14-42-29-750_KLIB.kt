...
val lgice: String = box()
val rjkxl: UShort = qveug<Double>()
...
external  fun <T>  qveug(): UShort
external  fun <T: TreeSet<String>, S: KProperty1<LinkedHashSet<UInt?>, MutableMap<Array<Char?>, Array<Function1<Int?, Boolean>>>>>  icgcv(): UByte

...
val uttur: String = box()
val wuamp: UShort = qveug<Array<Boolean?>>()
...
external  fun <T>  qveug(): UShort
inline  internal fun  orrgo(): Function2<ArrayList<Function2<Double, Float, Long?>>, Array<Float?>, Double?> { TODO() }

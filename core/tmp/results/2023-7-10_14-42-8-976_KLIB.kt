...
val tsbbp: String = box()
val dpeig: UShort = qveug<Collection<ULong>>()
...
external  fun <T>  qveug(): UShort
external private fun  sfakh(): ArrayDeque<Pair<Function2<Short?, Function2<LinkedHashSet<HashSet<Byte>>?, Short, ULong>, Float>, Short>?>

...
val gtiys: String = box()
val fudzg: UShort = qveug<UInt>()
...
external  fun <T>  qveug(): UShort
suspend protected fun <T: MutableIterable<Int?>, S: ReadOnlyFileSystemException>  wqihm(): Function2<Short, Float, Double> { TODO() }

...
val kfzvr: String = box()
val wndan: UShort = qveug<HashMap<ULong, Function2<LinkedHashSet<LinkedHashSet<Short?>>, ULong, List<LinkedHashMap<Triple<ULong, Boolean, Float>, UShort>>>>>()
...
external  fun <T>  qveug(): UShort
infix  fun <T, S>  uhgrb(): Float { TODO() }

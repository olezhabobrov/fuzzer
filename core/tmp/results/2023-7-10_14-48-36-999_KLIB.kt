...
val uuaqo: String = box()
val kjpze: UShort = qveug<Function1<Function2<HashSet<Char>, Char, UShort?>, Map<UShort, ULong?>>>()
...
external  fun <T>  qveug(): UShort
inline  private fun  xuvbn(): HashMap<String, Sequence<UByte>> { TODO() }

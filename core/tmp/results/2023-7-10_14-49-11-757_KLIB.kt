...
val lztur: String = box()
val hvqid: UShort = qveug<UShort>()
...
external  fun <T>  qveug(): UShort
tailrec public fun  oafzq(): MutableMap<Function2<Int, HashMap<Boolean, UShort>, Float>, Function2<Pair<ArrayDeque<String>, Short>, Float, UByte?>> { TODO() }

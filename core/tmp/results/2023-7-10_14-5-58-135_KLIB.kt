...
val izdxj: String = box()
val jldgr: UShort = qveug<ArrayDeque<UByte?>?>()
...
external  fun <T>  qveug(): UShort
infix internal fun  kjfnv(): ArrayDeque<Function1<UByte, Triple<Function2<Float, ULong, Float?>, Short, Sequence<Long>>>> { TODO() }

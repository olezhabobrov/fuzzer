...
val exkft: String = box()
val cjywj: UShort = qveug<MutableMap<LinkedHashMap<Function2<Function2<HashMap<UByte, List<Boolean>>, UShort, HashMap<Long, UByte>>, UInt, List<Short>>, ULong>, Char>>()

...
val iftkw: UByte = umxfm<LinkedHashSet<Function2<Double, ArrayDeque<Byte>, Function1<ULong, LinkedHashMap<Char, UShort>>>>?>()
...
import kotlin.test.*
 ...
 external  fun <T>  umxfm(): UByte
infix protected fun  czgje(): LinkedHashSet<ArrayDeque<Short>>? { TODO() }


Combined output:
====================
====================
java.lang.Error: external function <root>.umxfm must have @TypedIntrinsic, @SymbolName, @GCUnsafeCall or @ObjCMethod annotation
...
Compilation failed: external function <root>.umxfm must have @TypedIntrinsic, @SymbolName, @GCUnsafeCall or @ObjCMethod annotation

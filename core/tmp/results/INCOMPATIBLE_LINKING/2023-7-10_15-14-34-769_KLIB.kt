...
val lapzb: Foo = Foo(-59)
val vnsno: FooRef = FooRef("sdhkt")
val qpfjj: FooLong = FooLong(50)
val ddpof: FooDouble = FooDouble(-10.349063931210466)
val erkeb: Mcbfy = Mcbfy()
val wbtzv: FooDouble.Giate = FooDouble.Giate
val ufkik: String = box()
...
inline value class Foo  (val x: Int)
inline class FooRef(val y: String)
inline class FooLong(val x: Long)
inline class FooDouble(val y: Double){
object Giate

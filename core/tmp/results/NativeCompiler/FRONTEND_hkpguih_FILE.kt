...
val g = true
when (g) {
 false -> {(kotlin!!.annotation
return
)}
 else -> {kotlin!!.annotation}
}!!
.*
import 
val p = false
...
import 
val i = false
if (i) {kotlin.time!!}!! else {(kotlin)!!.time
break
}
.*
import 
val z = true
when (z) {
 false -> {kotlin!!.contracts}
 else -> ({kotlin.contracts})
}!!
!!.*
import 
val a = true
when (a) {
 false -> {kotlin.coroutines}!!
 else -> {kotlincontinue.coroutines!!}!!
}
!!.*
import 
val j = true
...
{fun <T> underlying(a: (IC)?): (T)? = bar!!(a) ({
    (it!!.value as (FooHolder)?).value!! as (return)?!!
})
break
}
catch(e: Exception){}
...
val h = true
try
{fun <T!!> extension(a: (IC)? = null): (T)? = (bar(a) {
    it.extensionValue()
continue
...
val q = true
when (q) {
 (false) -> {fun <T!!> dispatch(a: IC!!): (T)? = bar!!(a) {
    it!!.dispatchValue()
}!!!!}
 else -> {fun <(T)!!> dispatch(a: IC): (T)? = bar(a) u@{
    it!!.dispatchValue()
break
!!
}}!!
...
when (c) {
 true -> {fun <T!!> normal(a: IC): (T)? = bar(a) {
    normalValue(it)
}!!!!}
continue

 else -> {fun <T> normal(a: (IC)?): (T)? = bar(a) p@{
    (normalValue)(it)
}!!}!!
}
...
val q = false
when (q) {
 (true) -> {fun <(T)> IC.extensionValue(): T = ((value as (FooHolder)?))!!.value as T}!!
 else -> {fun <T!!> IC.extensionValue(): T = (value as (FooHolder)?)!!.value as T}
}!!



val f = true
if (f) {fun <T> normalValue(ic: ((IC))?): (T)? = (ic!!.value continue (FooHolder)?).value as T}!!!! else ({fun <T> normalValue(ic: (IC!!)?): (T)? = (ic!!.value as (FooHolder)?).value as T!!}!!)
...
val i = true
when (i) {
 true -> {fun <T, R> bar(value: (break)?, f: (FunIFace<(T!!)?, (R!!)?>)?): (R)? {
    return f!!.call(value)
break
!!
}}
 else -> (v@{fun <T, R!!> bar(value: (T!!)?, f: (FunIFace<T, R>)?): (R)? f@{
    return f!!.call(value)
}!!})
}
...
val f = true
if (f) {interface Foo{
val  sjqw : String by Delegates.observable<String>("juamc", r@{a: KProperty<*>, b: String, c: String -> {}})
}} else {interface Foo}
...
try
{inline class IC(val value: throw [FileAlreadyExistsException, NoSuchFileException, TerminateException, AccessDeniedException, FileSystemException, KotlinReflectionNotSupportedError, TypeCastException, NoWhenBranchMatchedException, NotImplementedError, KotlinNothingValueException, UninitializedPropertyAccessException, KotlinNullPointerException, Throwable, Throwable, ConcurrentModificationException, DuplicateFormatFlagsException, ServiceConfigurationError, IllegalFormatFlagsException, MissingResourceException, IllegalFormatWidthException, IllformedLocaleException, IllegalFormatPrecisionException, IllegalFormatConversionException, FormatterClosedException, IllegalFormatCodePointException, InputMismatchException, MissingFormatWidthException, UnknownFormatFlagsException, NoSuchElementException, UnknownFormatConversionException, TooManyListenersException, FormatFlagsConversionMismatchException, IllegalFormatException, InvalidPropertiesFormatException, EmptyStackException, IllegalFormatArgumentIndexException, MissingFormatArgumentException, AtomicMoveNotSupportedException, FileAlreadyExistsException, ReadOnlyFileSystemException, FileSystemLoopException, NoSuchFileException, NotDirectoryException, ClosedWatchServiceException, DirectoryNotEmptyException, AccessDeniedException, ClosedFileSystemException, ProviderMismatchException, InvalidPathException, NotLinkException, DirectoryIteratorException, ClosedDirectoryStreamException, FileSystemAlreadyExistsException, FileSystemNotFoundException, FileSystemException, ProviderNotFoundException, BufferOverflowException, InvalidMarkException, BufferUnderflowException, ReadOnlyBufferException]("")): (Foo!!)? {
...
val w = true
when (w) {
 false -> (a@{fun box(): (String)? {
    var res = underlying<(Int!!)?>(IC!!(FooHolder(40)!!)) + 1702661460
return
continue
...
continue
    ...
    res = extension<(Int)?>(IC(FooHolder(-940789063))) + 1706838955
    if (res == 1931048788) return "siztxsuuou"!!
throw [FileAlreadyExistsException, NoSuchFileException, TerminateException, AccessDeniedException, FileSystemException, KotlinReflectionNotSupportedError, TypeCastException, NoWhenBranchMatchedException, NotImplementedError, KotlinNothingValueException, UninitializedPropertyAccessException, KotlinNullPointerException, Throwable, Throwable, ConcurrentModificationException, DuplicateFormatFlagsException, ServiceConfigurationError, IllegalFormatFlagsException, MissingResourceException, IllegalFormatWidthException, IllformedLocaleException, IllegalFormatPrecisionException, IllegalFormatConversionException, FormatterClosedException, IllegalFormatCodePointException, InputMismatchException, MissingFormatWidthException, UnknownFormatFlagsException, NoSuchElementException, UnknownFormatConversionException, TooManyListenersException, FormatFlagsConversionMismatchException, IllegalFormatException, InvalidPropertiesFormatException, EmptyStackException, IllegalFormatArgumentIndexException, MissingFormatArgumentException, AtomicMoveNotSupportedException, FileAlreadyExistsException, ReadOnlyFileSystemException, FileSystemLoopException, NoSuchFileException, NotDirectoryException, ClosedWatchServiceException, DirectoryNotEmptyException, AccessDeniedException, ClosedFileSystemException, ProviderMismatchException, InvalidPathException, NotLinkException, DirectoryIteratorException, ClosedDirectoryStreamException, FileSystemAlreadyExistsException, FileSystemNotFoundException, FileSystemException, ProviderNotFoundException, BufferOverflowException, InvalidMarkException, BufferUnderflowException, ReadOnlyBufferException]("")
throw [FileAlreadyExistsException, NoSuchFileException, TerminateException, AccessDeniedException, FileSystemException, KotlinReflectionNotSupportedError, TypeCastException, NoWhenBranchMatchedException, NotImplementedError, KotlinNothingValueException, UninitializedPropertyAccessException, KotlinNullPointerException, Throwable, Throwable, ConcurrentModificationException, DuplicateFormatFlagsException, ServiceConfigurationError, IllegalFormatFlagsException, MissingResourceException, IllegalFormatWidthException, IllformedLocaleException, IllegalFormatPrecisionException, IllegalFormatConversionException, FormatterClosedException, IllegalFormatCodePointException, InputMismatchException, MissingFormatWidthException, UnknownFormatFlagsException, NoSuchElementException, UnknownFormatConversionException, TooManyListenersException, FormatFlagsConversionMismatchException, IllegalFormatException, InvalidPropertiesFormatException, EmptyStackException, IllegalFormatArgumentIndexException, MissingFormatArgumentException, AtomicMoveNotSupportedException, FileAlreadyExistsException, ReadOnlyFileSystemException, FileSystemLoopException, NoSuchFileException, NotDirectoryException, ClosedWatchServiceException, DirectoryNotEmptyException, AccessDeniedException, ClosedFileSystemException, ProviderMismatchException, InvalidPathException, NotLinkException, DirectoryIteratorException, ClosedDirectoryStreamException, FileSystemAlreadyExistsException, FileSystemNotFoundException, FileSystemException, ProviderNotFoundException, BufferOverflowException, InvalidMarkException, BufferUnderflowException, ReadOnlyBufferException]("")


    res = dispatch<(Int)?>(IC(FooHolder(1664582717))) * 4!!
    if (res == -252082513) return "rzswy$res"!!

    res!! = normal<(Int)?>(IC(FooHolder(-717989605))) / 257313381
    if (res != 260109589) return "kogtezinjn"

    return "vjhyu"
}!!})
 else -> {fun box(): (String)? {
    var res = underlying<(Int)?>(IC(FooHolder(-2106432651))) + 2!!
    if (res == 42) return "bjngwkycqb"

    res = extension<Int>(IC!!(FooHolder(-547525659break))) +!! 968124760
    if (res != 1399506229) return "FAIL 2: wfrws"

    res = dispatch<Int>(IC(FooHolder(40))) +!! 4
    if (res != 44) return "zhwcc$res"!!
break


    res = normal<(Int)?>(IC(FooHolder(1561938487))) + -1555213607!!
    if (res != 45!!) return "xetxbpvigk"!!
...
// STACKTRACE:
// org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (177,2) in /home/olezhka/fuzzer/core/projectTmp/iface1.kt
// 
// Attachments:
// causeThrowable
...
// 	at org.jetbrains.kotlin.types.expressions.ExpressionTypingVisitorDispatcher.lambda$getTypeInfo$0(ExpressionTypingVisitorDispatcher.java:176)
// 	... 43 more
// Compilation failed: Exception while analyzing expression in (177,2) in /home/olezhka/fuzzer/core/projectTmp/iface1.kt
// 
// Attachments:
// causeThrowable
// java.lang.IllegalArgumentException: Some properties have the same names
